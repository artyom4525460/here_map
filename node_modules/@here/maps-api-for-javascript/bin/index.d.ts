...
declare namespace H {
  ...
  class Map extends H.util.EventTarget {
     ...
     */
    constructor (element : GlobalElement | null , baseLayer : H.map.layer.Layer | null , opt_options ? : H.Map.Options ) ;
    /**
     ...
     */
    addLayer (layer : H.map.layer.Layer | null , opt_idx ? : number ) : H.Map | null ;
    /**
     ...
     */
    addObjects (mapObjects : H.map.Object [] | null ) : H.Map | null ;
    /**
     ...
     * @param callback Callback function to call once result of capture has completed
     ...
     */
    capture (callback : (a ? : HTMLCanvasElement | null ) => any , opt_capturables ? : ( H.util.ICapturable | null ) [] | null , opt_x1 ? : number , opt_y1 ? : number , opt_x2 ? : number , opt_y2 ? : number ) : void ;
    /**
     ...
     */
    clearContent (opt_onprogress ? : (a : H.util.Request | null ) => any ) : H.util.Request | null ;
    /**
     ...
     */
    geoToScreen (geoPoint : H.geo.IPoint | null ) : H.math.Point | null ;
    /**
     ...
     */
    getObjectAt (x : number , y : number , callback : (a : H.map.Feature | null | undefined ) => any ) : void ;
    /**
     ...
     */
    getObjects (opt_recursive ? : boolean ) : ( H.map.Object | null ) [] ;
    /**
     ...
     */
    getObjectsAt (x : number , y : number , callback : (a : ( H.map.Feature | null ) [] | null ) => any ) : void ;
    /**
     ...
     */
    getObjectsWithin (area : H.geo.Polygon , callback : (a : ( H.map.Object | null ) [] | null ) => any , opt_options ? : H.Map.GetObjectsWithinOptions ) : void ;
    /**
     ...
     */
    removeLayer (layer : H.map.layer.Layer | null ) : H.Map | null ;
    /**
     ...
     * Note that method can be used to remove only direct children of the root group of the default object layer.
     */
    removeObjects (mapObjects : H.map.Object [] | null ) : H.Map | null ;
    /**
     ...
     */
    setBaseLayer (layer : H.map.layer.Layer | null ) : H.Map | null ;
    /**
     ...
     */
    setCenter (center : H.geo.IPoint | null , opt_animate ? : boolean ) : H.Map | null ;
    /**
     * This method sets the rendering engine type for the map. The rendering engine
     * is responsible for displaying, for example, tiles and data on the map.
     */
    setEngineType (type : H.Map.EngineType ) : H.Map | null ;
    /**
     ...
     * @param opt_animate A value indicating if an animated transition should be applied, default is `false`
     */
    setZoom (zoom : number , opt_animate ? : boolean ) : H.Map | null ;
    /**
     ...
     */
    storeContent (opt_onprogress ? : (a : H.util.Request | null ) => any , opt_boundingBox ? : H.geo.Rect | null , opt_min ? : number , opt_max ? : number , opt_layer ? : H.map.layer.BaseTileLayer | null ) : H.util.Request | null ;
    /**
...
declare namespace H.Map {
  ...
  type Options = { autoColor ? : boolean , bounds ? : H.geo.AbstractGeometry | null , center ? : H.geo.IPoint | null , engineType ? : H.Map.EngineType , imprint ? : H.map.Imprint.Options | null , layers ? : ( H.map.layer.Layer | null ) [] | null , margin ? : number , padding ? : H.map.ViewPort.Padding , pixelRatio ? : number , renderBaseBackground ? : H.Map.BackgroundRange , zoom ? : number } ;
}
...
declare namespace H.clustering {
  ...
  interface ICluster extends H.clustering.IResult {
     ...
     */
    forEachDataPoint (callback : (a : H.clustering.INoisePoint | null ) => any ) : void ;
    /**
     ...
     */
    forEachEntry (callback : (a : H.clustering.IResult | null ) => any ) : void ;
    /**
...
declare namespace H.clustering {
  ...
  interface ITheme {
     ...
     */
    getClusterPresentation (cluster : H.clustering.ICluster | null ) : H.map.Object | null ;
    /**
     ...
     */
    getNoisePresentation (noisePoint : H.clustering.INoisePoint | null ) : H.map.Object | null ;
  }
}
declare namespace H.clustering {
  /**
  ...
  class Provider extends H.map.provider.LocalObjectProvider {
     ...
     */
    constructor (dataPoints : ( H.clustering.DataPoint | null ) [] | null , opt_options ? : H.clustering.Provider.Options ) ;
    /**
     ...
     */
    addDataPoint (dataPoint : H.clustering.DataPoint | null ) : void ;
    /**
     ...
     */
    addDataPoints (dataPoints : ( H.clustering.DataPoint | null ) [] | null ) : void ;
    /**
     * This method retrieves the current theme used for cluster visualizations.
     */
    getTheme ( ) : H.clustering.ITheme | null ;
     ...
     */
    removeDataPoint (dataPoint : H.clustering.DataPoint | null ) : void ;
    /**
     * This method sets a new data on the provider class.
     * @param dataPoints A set of data points
     */
    setDataPoints (dataPoints : ( H.clustering.DataPoint | null ) [] | null ) : void ;
    /**
     ...
     */
    setTheme (theme : H.clustering.ITheme | null ) : void ;
  }
}
declare namespace H.clustering.Provider {
  type ClusteringOptions = { eps ? : number , minWeight ? : number , projection ? : H.geo.IProjection | null , strategy ? : H.clustering.Provider.Strategy } ;
  type Options = { clusteringOptions ? : H.clustering.Provider.ClusteringOptions , getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , max ? : number , min ? : number , pixelRatio ? : number , theme ? : H.clustering.ITheme | null , uri ? : string } ;
  /**
...
declare namespace H.data {
  ...
  abstract class AbstractReader extends H.util.EventTarget {
     ...
     */
    getLayer ( ) : H.map.layer.ObjectLayer | null ;
    /**
     ...
     */
    getParsedObjects ( ) : ( H.map.Object | null ) [] | null ;
    /**
     ...
     */
    setUrl (url : string ) : H.data.AbstractReader | null ;
  }
}
...
declare namespace H.data.AbstractReader {
  ...
  class Event extends H.util.Event {
     ...
     */
    constructor (target : H.data.AbstractReader | null | H.map.Object , type : string , state : H.data.AbstractReader.State , message : string ) ;
  }
}
declare namespace H.data.geojson {
  ...
  class Reader extends H.data.AbstractReader {
     ...
     */
    parseData (data : string | GlobalObject | null ) : void ;
  }
}
declare namespace H.data.geojson.Reader {
  type Options = { disableLegacyMode ? : boolean , style ? : (a : H.map.Object | null ) => any } ;
}
...
declare namespace H.data.heatmap {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
     ...
     */
    addData (dataPoints : ( H.data.heatmap.IDataPoint | null ) [] | null , opt_hardReload ? : boolean ) : void ;
    /**
    ...
    requestInternal (col : number , row : number , level : number , onResponse : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.data.heatmap.Provider {
  type Options = { assumeValues ? : boolean , coarseness ? : number , colors ? : H.data.heatmap.Colors | null , max ? : number , min ? : number , opacity ? : number , sampleDepth ? : number , tileSize ? : number , type ? : string } ;
}
...
declare namespace H.geo {
  ...
  interface IProjection {
     ...
     */
    geoToPoint (geoPoint : H.geo.IPoint | null , opt_out ? : H.math.Point | null ) : H.math.Point | null ;
    /**
     ...
     * @param opt_out An optional point to receive the result
     */
    latLngToPoint (lat : number , lng : number , opt_out ? : H.math.Point | null ) : H.math.Point | null ;
    /**
     ...
     */
    pointToGeo (point : H.math.IPoint | null , opt_out ? : H.geo.Point | null ) : H.geo.Point | null ;
    /**
     ...
     */
    xyToGeo (x : number , y : number , opt_out ? : H.geo.Point | null ) : H.geo.Point | null ;
  }
}
declare namespace H.geo {
  /**
  ...
  class LineString extends H.geo.AbstractGeometry {
     ...
     */
    constructor (opt_latLngAlts ? : number [] | null ) ;
    /**
     ...
     */
    eachLatLngAlt (eachFn : (a : number , b : number , c : number | undefined , d : number ) => any , opt_start ? : number , opt_end ? : number ) : void ;
     ...
     */
    extractPoint (pointIndex : number , opt_out ? : H.geo.Point | null ) : H.geo.Point | null ;
    /**
     ...
     */
    insertLatLngAlt (index : number , lat : number , lng : number , alt : number | undefined ) : void ;
    /**
     * This method inserts the lat, lng, alt values of a {@link H.geo.Point} into the list
     * at the specified index.
     */
    insertPoint (pointIndex : number , geoPoint : H.geo.IPoint | null ) : void ;
    /**
     ...
     * of this LineString.
     */
    pushPoint (geoPoint : H.geo.IPoint | null ) : void ;
    /**
     ...
     */
    spliceLatLngAlts (index : number , opt_nRemove ? : number , opt_latLngAlts ? : number [] | null ) : number [] | null ;
    /**
     ...
     * the `LineString`.
     */
    static fromFlexiblePolyline (encodedPolyline : string ) : H.geo.LineString | null ;
    /**
     ...
     */
    static fromLatLngArray (latLngs : number [] | null ) : H.geo.LineString | null ;
    /**
     * To obtain whether a leg (formed by the given two longitudes) crosses the International Date Line.
     * @param lng1 The start longitude of the leg
     * @param lng2 The end longitude of the leg
...
declare namespace H.geo {
  ...
  class PixelProjection {
     ...
     */
    constructor (opt_projection ? : H.geo.IProjection | null , opt_sizeAtLevelZero ? : number ) ;
    /**
     ...
     */
    geoToPixel (geoPoint : H.geo.IPoint | null , opt_out ? : H.math.IPoint | null ) : H.math.IPoint | null ;
    /**
     ...
     * @param opt_out An optional point to store the result
     */
    latLngToPixel (latitude : number , longitude : number , opt_out ? : H.math.IPoint | null ) : H.math.Point | null ;
    /**
     ...
     * @param opt_out An optional point to store the result
     */
    pixelToGeo (point : H.math.IPoint | null , opt_out ? : H.geo.IPoint | null ) : H.geo.IPoint | null ;
    /**
...
declare namespace H.geo {
  ...
  class Point extends H.geo.AbstractGeometry implements H.geo.IPoint {
     ...
     */
    distance (other : H.geo.IPoint | null ) : number ;
    equals (other : any ) : boolean ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    lat : number ;
    lng : number ;
     ...
     */
    walk (bearing : number , distance : number , opt_overGreatCircle ? : boolean ) : H.geo.Point | null ;
    /**
     * This method creates a `Point` instance from an `IPoint` object.
     * @param iPoint The `IPoint` object to use
     */
    static fromIPoint (iPoint : H.geo.IPoint | null ) : H.geo.Point | null ;
    /**
     ...
     */
    static validate (this : H.geo.Point , point : H.geo.IPoint | null , opt_caller ? : Function | null , opt_argNr ? : number ) : boolean ;
  }
}
declare namespace H.geo {
  /**
  ...
  class Polygon extends H.geo.AbstractGeometry {
     ...
     */
    constructor (exterior : H.geo.LineString | null , opt_interiors ? : ( H.geo.LineString | null ) [] | null ) ;
    equals (other : any ) : boolean ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    /**
     * To obtain the exterior ring of the polygon.
     */
    getExterior ( ) : H.geo.LineString | null ;
    /**
     * To obtain a reference to the list of interior rings of the polygon.
     */
    getInteriors ( ) : ( H.geo.LineString | null ) [] | null ;
    /**
     ...
     */
    pushInterior (interior : H.geo.LineString | null ) : void ;
    /**
     * To remove the specified interior ring.
     * @param interior The interior ring to remove.
     */
    removeInterior (interior : H.geo.LineString | null ) : H.geo.LineString | undefined ;
    /**
     ...
     */
    setExterior (exterior : H.geo.LineString | null ) : void ;
    /**
     ...
     */
    setPoleCovering (direction : H.geo.Polygon.Direction ) : H.geo.Polygon | null ;
    /**
     ...
     */
    spliceInteriors (opt_index ? : number , opt_deleteCount ? : number ,  ...var_args : H.geo.LineString [] ) : ( H.geo.LineString | null ) [] | null ;
  }
}
...
declare namespace H.geo {
  ...
  class Rect extends H.geo.AbstractGeometry {
     ...
     */
    containsPoint (geoPoint : H.geo.IPoint | null , opt_skipValidation ? : boolean ) : boolean ;
    /**
     ...
     * @param opt_skipValidation A Boolean indicating whether to check validity of the arguments (`true`)
     */
    containsRect (geoRect : H.geo.Rect | null , opt_skipValidation ? : boolean ) : boolean ;
    equals (other : any ) : boolean ;
    /**
     ...
     */
    getBottomRight ( ) : H.geo.Point | null ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    /**
     ...
     * @param opt_skipValidation A Boolean indicating whether to check validity of the arguments (`true`)
     */
    intersects (geoRect : H.geo.Rect | null , opt_skipValidation ? : boolean ) : boolean ;
    /**
     ...
     */
    mergeLatLng (lat : number , lng : number , opt_skipValidation ? : boolean , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
    /**
     * This method retrieves the smallest bounding box that covers the given rectangular
     ...
     * @param opt_out An optional rectangle object to store the result
     */
    mergePoint (geoPoint : H.geo.IPoint | null , opt_skipValidation ? : boolean , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
    /**
     ...
     * @param opt_out an optional rectangle object to store the result
     */
    mergeRect (geoRect : H.geo.Rect | null , opt_skipValidation ? : boolean , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
    /**
     * This method retrieves the smallest bounding box that covers the given rectangle
     ...
     * @param opt_out An optional rectangle object to store the result
     */
    mergeTopLeftBottomRight (top : number , left : number , bottom : number , right : number , opt_skipValidation ? : boolean , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
    /**
     ...
     * @param opt_out An optional rectangle object to store the result
     */
    resizeToCenter (center : H.geo.IPoint | null , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
    /**
     ...
     * @param opt_skipValidation A Boolean indicating whether to check validity of the arguments (`true`)
     */
    static coverLatLngAlts (latLngAltArray : number [] | null , opt_skipValidation ? : boolean ) : H.geo.Rect | null | undefined ;
    /**
     ...
     * @param opt_skipValidation A Boolean indicating whether to check validity of the arguments (`true`)
     */
    static coverPoints (pointArray : ( H.geo.IPoint | null ) [] | null , opt_skipValidation ? : boolean ) : H.geo.Rect | null ;
    /**
     ...
     * @param opt_skipValidation A Boolean indicating whether to check validity of the arguments (`true`)
     */
    static coverRects (rectList : ( H.geo.Rect | null ) [] | null , opt_skipValidation ? : boolean ) : H.geo.Rect | null | undefined ;
    /**
     ...
     * @param opt_skipValidation A Boolean flag indicating whether to check validity of the arguments (`true`)
     */
    static fromPoints (topLeft : H.geo.IPoint | null , bottomRight : H.geo.IPoint | null , opt_skipValidation ? : boolean ) : H.geo.Rect | null ;
    /**
     ...
     */
    static merge (topA : number , leftA : number , bottomA : number , rightA : number , topB : number , leftB : number , bottomB : number , rightB : number , opt_out ? : H.geo.Rect | null ) : H.geo.Rect | null ;
  }
}
declare namespace H.geo {
  /**
   ...
   */
  let mercator : H.geo.IProjection | null ;
}
declare namespace H.lang {
  ...
  class IllegalOperationError extends Error {
     ...
     */
    constructor (opt_caller ? : Function | null , opt_message ? : any ) ;
  }
}
declare namespace H.lang {
  /**
  ...
  class InvalidArgumentError extends Error {
     ...
     * @param opt_message The text of the error message to output
     */
    constructor (opt_caller ? : Function | null , opt_argNr ? : number | null , opt_message ? : any ) ;
  }
}
declare namespace H.lang {
  /**
  ...
  class OutOfRangeError extends Error {
     ...
     */
    constructor (opt_caller ? : Function | null , opt_val ? : number , opt_range ? : number [] | null ) ;
  }
}
declare namespace H.map {
  /**
  ...
  abstract class AbstractMarker extends H.map.Object {
     ...
     */
    constructor (geometry : H.geo.IPoint | null | H.geo.MultiPoint , opt_options ? : H.map.AbstractMarker.Options ) ;
    /**
     ...
     */
    getGeometry ( ) : H.geo.Point | null | H.geo.MultiPoint ;
    /**
     ...
     * integrity of the marker.
     */
    setGeometry (geometry : H.geo.IPoint | null | H.geo.MultiPoint ) : H.map.AbstractMarker | null ;
    /**
     * This method sets the marker icon.
     * @param icon The new marker icon
     */
    setIcon (icon : H.map.Icon | H.map.DomIcon ) : H.map.AbstractMarker | null ;
  }
}
declare namespace H.map.AbstractMarker {
  type Options = { data : any , icon ? : H.map.Icon | null | H.map.DomIcon , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class ArrowStyle {
     ...
     */
    constructor (opt_options ? : H.map.ArrowStyle | null | H.map.ArrowStyle.Options ) ;
    /**
     ...
     */
    equals (other : H.map.ArrowStyle | null | H.map.ArrowStyle.Options ) : boolean ;
  }
}
...
declare namespace H.map {
  ...
  class ChangeEvent extends H.util.ChangeEvent {
     ...
     */
    constructor (type : string , newValue : GlobalObject | null , oldValue : GlobalObject | null , modifiers : number ) ;
    /**
...
declare namespace H.map {
  ...
  class Circle extends H.map.Polygon {
     ...
     */
    constructor (center : H.geo.IPoint | null , radius : number , opt_options ? : H.map.Circle.Options ) ;
    /**
     ...
     */
    getCenter ( ) : H.geo.IPoint | null ;
    getGeometry ( ) : H.geo.Polygon | null | H.geo.MultiPolygon ;
    /**
     ...
     */
    setCenter (center : H.geo.IPoint | null ) : void ;
    setGeometry (a ? : H.geo.Polygon | null | H.geo.MultiPolygon ) : H.map.Polygon | null ;
    /**
...
declare namespace H.map.Circle {
  type Options = { data : any , elevation ? : number , extrusion ? : number , max ? : number , min ? : number , precision : number , provider ? : H.map.provider.ObjectProvider | null , style : H.map.SpatialStyle | null , visibility : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class DataModel extends H.util.OList {
     ...
     */
    constructor (opt_layers ? : any [] | null ) ;
    /**
     ...
     */
    add (layer : H.map.layer.Layer | null , opt_idx ? : number ) : void ;
    /**
     ...
     */
    remove (layer : H.map.layer.Layer | null ) : boolean ;
    /**
     ...
     */
    removeAt (idx : number ) : H.map.layer.Layer | null ;
    /**
     ...
     */
    set (idx : number , layer : H.map.layer.Layer | null ) : H.map.layer.Layer | null ;
  }
}
declare namespace H.map {
  /**
...
declare namespace H.map.DomIcon {
  type Options = { onAttach ? : (a : GlobalElement | null , b : H.map.DomIcon | null , c : H.map.DomMarker | null ) => any , onDetach ? : (a : GlobalElement | null , b : H.map.DomIcon | null , c : H.map.DomMarker | null ) => any } ;
}
declare namespace H.map {
  /**
  ...
  class DomMarker extends H.map.AbstractMarker {
     ...
     * @param opt_options The options to initialize the marker
     */
    constructor (position : H.geo.IPoint | null | H.geo.MultiPoint , opt_options ? : H.map.DomMarker.Options ) ;
  }
}
declare namespace H.map.DomMarker {
  type Options = { data : any , icon ? : H.map.DomIcon | null , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
...
declare namespace H.map {
  ...
  class Group extends H.map.Object {
     ...
     */
    addObjects (objects : H.map.Object [] | null ) : void ;
     ...
     */
    toGeoJSON (opt_callback ? : (a : any ) => any ) : GlobalObject | null ;
  }
}
declare namespace H.map.Group {
  type Options = { data : any , max ? : number , min ? : number , objects ? : ( H.map.Object | null ) [] | null , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class HitArea {
     ...
     */
    constructor (shapeType : H.map.HitArea.ShapeType , opt_coords ? : number [] | null ) ;
  }
}
...
declare namespace H.map {
  ...
  interface IControl {
     ...
     */
    startControl (opt_kinetics ? : H.util.kinetics.IKinetics | null , opt_atX ? : number , opt_atY ? : number ) : void ;
  }
}
declare namespace H.map {
  /**
...
declare namespace H.map {
  ...
  namespace IInteraction {
     ...
     */
    startInteraction (modifiers : number , opt_kinetics ? : H.util.kinetics.IKinetics | null ) : void ;
  }
...
declare namespace H.map.Icon {
  type Options = { anchor ? : H.math.IPoint | null , crossOrigin ? : string | null , hitArea ? : H.map.HitArea | null , size ? : H.math.ISize | null , stickColor ? : string | null , stickHeight ? : number | null } ;
  /**
...
declare namespace H.map {
  ...
  class Imprint extends H.util.Disposable implements H.util.ICapturable {
     ...
     */
    constructor (map : H.Map | null , opt_options ? : H.map.Imprint.Options ) ;
    /**
    ...
    capture (canvas : HTMLCanvasElement | null , pixelRatio : number , callback : (a ? : HTMLCanvasElement | null ) => any , opt_errback ? : (a : string ) => any ) : void ;
    /**
...
declare namespace H.map.Imprint {
  type Options = { font ? : string , href ? : string , invert ? : boolean , locale ? : string } ;
}
declare namespace H.map {
  /**
  ...
  class Marker extends H.map.AbstractMarker {
     ...
     * @param opt_options The options to initialize the marker
     */
    constructor (position : H.geo.IPoint | null | H.geo.MultiPoint , opt_options ? : H.map.Marker.Options ) ;
    invalidate (flags : number ) : boolean ;
    setIcon (icon : H.map.Icon | H.map.DomIcon ) : H.map.AbstractMarker | null ;
  }
}
declare namespace H.map.Marker {
  type Options = { data : any , icon ? : H.map.Icon | null , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  abstract class Object extends H.map.Feature {
     ...
     */
    compareZOrder (other : H.map.Object | null ) : number ;
    /**
     ...
     */
    getInvalidations ( ) : H.map.provider.Invalidations | null ;
    /**
     ...
     */
    setData (data : any ) : H.map.Object | null ;
    /**
     ...
     */
    setRemoteId (id : number | string ) : H.map.Object | null ;
    /**
     ...
     */
    setVisibility (opt_visibility ? : boolean ) : H.map.Object | null ;
    /**
     ...
     */
    setVolatility (opt_volatility ? : boolean ) : H.map.Object | null ;
    /**
     * This method sets the z-index of the given object.
     * @param zIndex A value indicating the new z-index
     */
    setZIndex (zIndex : number | undefined ) : H.map.Object | null ;
    /**
     ...
     */
    static compareZOrder (first : H.map.Object | null , second : H.map.Object | null ) : number ;
  }
}
declare namespace H.map.Object {
  type Options = { data : any , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
  /**
...
declare namespace H.map {
  ...
  class Overlay extends H.map.Object {
     ...
     */
    constructor (boundingBox : H.geo.Rect | null , bitmap : string | HTMLImageElement | HTMLCanvasElement , opt_options ? : H.map.Overlay.Options ) ;
    /**
     ...
     */
    setBitmap (bitmap : string | HTMLImageElement | HTMLCanvasElement , opt_crossOrigin ? : string ) : H.map.Overlay | null ;
    /**
     ...
     */
    setBoundingBox (boundingBox : H.geo.Rect | null ) : H.map.Overlay | null ;
    /**
     ...
     */
    setGeometry (geometry : H.geo.Rect | null ) : H.map.Overlay | null ;
    /**
     ...
     */
    setOpacity (opacity : number ) : H.map.Overlay | null ;
  }
}
declare namespace H.map.Overlay {
  type Options = { crossOrigin ? : string | null , data : any , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class Polygon extends H.map.GeoShape {
    /**
     * A Polygon is a visual representation of a surface on a map.
     * @param geometry The geometry that defines the surface of the polygon. `H.geo.LineString` is interpreted as an exterior ring of `H.geo.Polygon` object.
     * @param opt_options An optional object containing initialization parameters
     */
    constructor (geometry : H.geo.LineString | null | H.geo.Polygon | H.geo.MultiPolygon , opt_options ? : H.map.Polygon.Options ) ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    /**
     ...
     * integrity of the polygon.
     */
    setGeometry (geometry : H.geo.Polygon | null | H.geo.MultiPolygon ) : H.map.Polygon | null ;
    /**
...
declare namespace H.map.Polygon {
  type Options = { arrows ? : H.map.ArrowStyle | null | H.map.ArrowStyle.Options , data : any , elevation ? : number , extrusion ? : number , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , style ? : null | H.map.SpatialStyle.Options , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class Polyline extends H.map.GeoShape {
     ...
     */
    constructor (geometry : H.geo.LineString | null | H.geo.MultiLineString , opt_options ? : H.map.Spatial.Options ) ;
    /**
     * Clips the geometry of the Polyline to a rectangular area
     * @param geoRect The rectangle to clip against.
     */
    clip (geoRect : H.geo.Rect | null ) : ( number [] | null ) [] | null ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    /**
     ...
     */
    getGeometry ( ) : H.geo.LineString | null | H.geo.MultiLineString ;
    /**
     ...
     */
    setGeometry (geometry : H.geo.LineString | null | H.geo.MultiLineString ) : H.map.Polyline | null ;
  }
}
declare namespace H.map.Polyline {
  type Options = { arrows ? : H.map.ArrowStyle | null | H.map.ArrowStyle.Options , data : any , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , style ? : null | H.map.SpatialStyle.Options , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class Rect extends H.map.Polygon {
     ...
     * @param opt_options An object containing configuration options.
     */
    constructor (boundingBox : H.geo.Rect | null , opt_options ? : H.map.Polygon.Options ) ;
    getBoundingBox ( ) : H.geo.Rect | null ;
    getGeometry ( ) : H.geo.Polygon | null | H.geo.MultiPolygon ;
    /**
     ...
     */
    setBoundingBox (boundingBox : H.geo.Rect | null ) : void ;
    setGeometry (a ? : H.geo.Polygon | null | H.geo.MultiPolygon ) : H.map.Polygon | null ;
  }
}
...
declare namespace H.map {
  ...
  abstract class Spatial extends H.map.Object {
     ...
     */
    getArrows ( ) : H.map.ArrowStyle | null | undefined ;
    /**
     ...
     */
    getStyle ( ) : H.map.SpatialStyle | null ;
    /**
     ...
     */
    setArrows (opt_arrows ? : H.map.ArrowStyle | null | H.map.ArrowStyle.Options ) : H.map.Spatial | null ;
    /**
     ...
     */
    setStyle (opt_style ? : null | H.map.SpatialStyle.Options ) : H.map.Spatial | null ;
  }
}
declare namespace H.map.Spatial {
  type Label = { angle : number , color : string , font : string , lines : string [] | null , size : number , x : number , y : number } ;
  type Options = { arrows ? : H.map.ArrowStyle | null | H.map.ArrowStyle.Options , data : any , max ? : number , min ? : number , provider ? : H.map.provider.ObjectProvider | null , style ? : null | H.map.SpatialStyle.Options , visibility ? : boolean , volatility ? : boolean , zIndex ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class SpatialStyle {
     ...
     */
    constructor (opt_options ? : null | H.map.SpatialStyle.Options ) ;
    /**
     ...
     */
    equals (other : null | H.map.SpatialStyle.Options ) : boolean ;
    /**
     ...
     */
    getCopy (opt_attributes ? : H.map.SpatialStyle.Options ) : H.map.SpatialStyle | null ;
    /**
     ...
     * It's value is:
     */
    static DEFAULT_STYLE : H.map.SpatialStyle | null ;
    /**
...
declare namespace H.map.SpatialStyle {
  ...
  type Options = { fillColor ? : string , lineCap ? : string , lineDash ? : number [] | null , lineDashOffset ? : number , lineHeadCap ? : string , lineJoin ? : string , lineTailCap ? : string , lineWidth ? : number , miterLimit ? : number , strokeColor ? : string } ;
}
declare namespace H.map {
  /**
...
declare namespace H.map {
  ...
  class ViewModel extends H.util.EventTarget implements H.map.IControl {
     ...
     * @param opt_animate A value indicating if an animated transition should be applied, default is `false`.
     */
    setLookAtData (data : H.map.ViewModel.ILookAtData , opt_animate ? : boolean ) : H.map.ViewModel | null ;
    /**
     * To start the controlling of the look-at-point animation. After this method was invoked, the look-at-point
     ...
     * @param opt_atY The y screen coordinate at which control starts
     */
    startControl (a ? : H.util.kinetics.IKinetics | null , b ? : number , c ? : number ) : void ;
  }
}
declare namespace H.map.ViewModel {
  type ILookAtData = { bounds ? : H.geo.Polygon | null , heading ? : number , incline ? : number , position ? : H.geo.IPoint | null , tilt ? : number , zoom ? : number } ;
}
declare namespace H.map {
  /**
  ...
  class ViewPort extends H.util.EventTarget implements H.map.IInteraction {
     ...
     */
    constructor (element : GlobalElement | null , opt_options ? : H.map.ViewPort.Options ) ;
    /**
     * This property holds a value indicating the current center point of the viewport.
     */
    center : H.math.Point | null ;
    /**
     ...
     */
    startInteraction (a : number , b ? : H.util.kinetics.IKinetics | null ) : any ;
    /**
...
declare namespace H.map.layer {
  ...
  class BaseTileLayer extends H.map.layer.Layer {
     ...
     */
    constructor (provider : H.map.provider.TileProvider | null , opt_options ? : H.map.layer.ITileLayer.Options ) ;
    /**
     ...
     */
    geoRectToRect (geoRect : H.geo.Rect | null , opt_zoom ? : number ) : H.math.Rect | null ;
    getCopyrights (boundingBox : H.geo.Rect | null , level : number ) : ( H.map.ICopyright | null ) [] | null ;
    /**
     ...
     */
    getProviderTiles (tileGridBoundary : H.math.Rect | null , isCDB : boolean , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null , opt_requesterId ? : any ) : H.map.layer.ITileLayer.Response ;
    /**
     ...
     */
    getTileBounds (boundingBox : H.math.Rect | null , zoom : number ) : H.math.Rect | null ;
    /**
     ...
     */
    requestTile (x : number , y : number , z : number , cacheOnly : boolean ) : H.map.provider.Tile | null | undefined ;
    /**
...
declare namespace H.map.layer {
  ...
  class DomLayer extends H.map.layer.Layer {
     ...
     * @param opt_options An optional configuration object
     */
    constructor (renderCallback : (a : GlobalElement | null , b : H.map.render.RenderingParams ) => H.map.render.RenderState , opt_options ? : H.map.layer.Layer.Options ) ;
  }
}
declare namespace H.map.layer {
  /**
  ...
  interface IMarkerLayer {
     ...
     */
    requestDomMarkers (boundingBox : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null ) : H.map.layer.IMarkerLayer.Response ;
    /**
     ...
     * @param prioCenter The priority center as an offset in screen pixels relative to the center
     */
    requestMarkers (boundingBox : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null ) : H.map.layer.IMarkerLayer.Response ;
  }
}
declare namespace H.map.layer.IMarkerLayer {
  type Response = { markers : ( H.map.AbstractMarker | null ) [] | null , total : number } ;
  type TiledResponse = { markers : ( H.map.AbstractMarker | null ) [] | null , requested : number , total : number } ;
}
declare namespace H.map.layer {
  /**
  ...
  interface ISpatialLayer {
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered `true`
     */
    requestSpatials (boundingBox : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean ) : ( H.map.Object | null ) [] | null ;
  }
}
declare namespace H.map.layer {
  /**
  ...
  interface ITileLayer {
     ...
     * @param opt_requesterId Unique identifier of the requester, is used when layer is shared between different maps
     */
    requestTiles (boundingBox : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null , opt_requesterId ? : any ) : H.map.layer.ITileLayer.Response ;
  }
}
declare namespace H.map.layer.ITileLayer {
  type Options = { dark ? : boolean , max ? : number , min ? : number , projection ? : H.geo.IProjection | null } ;
  type Response = { tiles : ( H.map.provider.Tile | null ) [] | null , total : number } ;
}
declare namespace H.map.layer {
  /**
  ...
  class Layer extends H.util.EventTarget {
     ...
     */
    getProvider ( ) : H.map.provider.Provider | null ;
    /**
     ...
     */
    pixelProjection : H.geo.PixelProjection | null ;
    /**
     ...
     */
    setMax (max : number ) : H.map.layer.Layer | null ;
    /**
     ...
     */
    setMin (min : number ) : H.map.layer.Layer | null ;
  }
}
declare namespace H.map.layer.Layer {
  type Options = { dark ? : boolean , max ? : number , min ? : number , minWorldSize ? : number , projection ? : H.geo.IProjection | null , provider ? : H.map.provider.Provider | null } ;
}
declare namespace H.map.layer {
  /**
  ...
  class MarkerTileLayer extends H.map.layer.BaseTileLayer implements H.map.layer.IMarkerLayer {
     ...
     */
    constructor (provider : H.map.provider.RemoteTileProvider | null , opt_options ? : H.map.layer.ITileLayer.Options ) ;
    requestDomMarkers (geoRect : H.geo.Rect | null , zoom : number , cacheOnly : boolean , prioCenter : H.math.Point | null ) : H.map.layer.IMarkerLayer.Response ;
    requestMarkers (geoRect : H.geo.Rect | null , zoom : number , cacheOnly : boolean , prioCenter : H.math.Point | null ) : H.map.layer.IMarkerLayer.Response ;
  }
}
declare namespace H.map.layer {
  /**
  ...
  class ObjectLayer extends H.map.layer.Layer implements H.map.layer.ITileLayer , H.map.layer.IMarkerLayer {
     ...
     */
    constructor (provider : H.map.provider.ObjectProvider | null , opt_options ? : H.map.layer.ObjectLayer.Options ) ;
    /**
     ...
     * @param prioCenter The priority center as an offset in screen pixel relative to the center
     */
    requestOverlays (boundingBox : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null ) : H.map.layer.ObjectLayer.OverlaysResponse ;
    /**
     ...
     */
    requestTiles (geoRect : H.geo.Rect | null , zoomLevel : number , cacheOnly : boolean , prioCenter : H.math.Point | null , e ? : any ) : H.map.layer.ITileLayer.Response ;
  }
}
declare namespace H.map.layer.ObjectLayer {
  ...
  type OverlaysResponse = { overlays : ( H.map.Overlay | null ) [] | null , total : number } ;
}
declare namespace H.map.layer {
  /**
...
declare namespace H.map.provider {
  ...
  class ImageTileProvider extends H.map.provider.RemoteTileProvider {
     ...
     */
    getOpacity ( ) : number ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , priority ? : number ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.map.provider.ImageTileProvider {
  type Options = { crossOrigin ? : string | null , getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , getURL : (a : number , b : number , c : number ) => string | undefined , headers ? : GlobalObject | null , max ? : number , min ? : number , opacity ? : number , tileSize ? : number , uri ? : string } ;
}
declare namespace H.map.provider {
  /**
...
declare namespace H.map.provider {
  ...
  class LocalObjectProvider extends H.map.provider.ObjectProvider {
     ...
     */
    getRootGroup ( ) : H.map.Group | null ;
    getStyleInternal ( ) : H.map.render.Style < any > | null ;
    ...
    requestDomMarkers (geoRect : H.geo.Rect | null , zoom : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.DomMarker [] ;
    requestMarkers (geoRect : H.geo.Rect | null , zoom : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Marker [] ;
    requestOverlays (geoRect : H.geo.Rect | null , zoom : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Overlay [] ;
    requestSpatials (geoRect : H.geo.Rect | null , zoom : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Spatial [] ;
  }
}
declare namespace H.map.provider {
  /**
  ...
  class MarkerTileProvider extends H.map.provider.RemoteTileProvider {
    ...
    /**
     * This method checks whether the given provider currently provides {@link H.map.DomMarker} map objects.
     */
    providesDomMarkers ( ) : boolean ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
  }
}
declare namespace H.map.provider.MarkerTileProvider {
  type Options = { max ? : number , min ? : number , providesDomMarkers ? : boolean , requestData : (a : number , b : number , c : number , d : (a : ( H.map.AbstractMarker | null ) [] | null ) => any , e : Function | null ) => H.util.ICancelable | null } ;
}
declare namespace H.map.provider {
  /**
  ...
  abstract class ObjectProvider extends H.map.provider.Provider {
     ...
     */
    getInvalidations (opt_type ? : H.map.Object.Type ) : H.map.provider.Invalidations | null ;
    /**
     * This method signals to the provider that a map object has changed.
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestDomMarkers (geoRect : H.geo.Rect | null , zoomLevel : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.DomMarker [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestMarkers (geoRect : H.geo.Rect | null , zoomLevel : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Marker [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestOverlays (geoRect : H.geo.Rect | null , zoomLevel : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Overlay [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestSpatials (geoRect : H.geo.Rect | null , zoomLevel : number , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Spatial [] ;
  }
}
declare namespace H.map.provider {
  /**
  ...
  class Provider extends H.util.EventTarget {
     ...
     */
    setStyleInternal (style : H.map.render.Style < any > | null , opt_suppressChangeEvent ? : boolean ) : void ;
    /**
...
declare namespace H.map.provider.Provider {
  type Options = { getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , max ? : number , min ? : number , uri ? : string } ;
}
declare namespace H.map.provider {
  /**
  ...
  abstract class RemoteTileProvider extends H.map.provider.TileProvider {
    ...
    protected createTileInternal (x : number , y : number , z : number , data : HTMLImageElement | null | HTMLCanvasElement | GlobalObject , opt_options ? : { [ key: string ]: any } | null ) : H.map.provider.Tile | null ;
    /**
     * This method retrieves a tile cache of this provider.
     */
    getCache ( ) : H.util.ICache | null ;
    /**
     ...
     */
    abstract requestInternal (x : number , y : number , z : number , onResponse : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , opt_priority ? : number ) : H.util.ICancelable | null ;
    requestTile (x : number , y : number , z : number , cacheOnly : boolean ) : H.map.provider.Tile | null | undefined ;
  }
}
declare namespace H.map.provider {
...
declare namespace H.map.provider {
  ...
  abstract class TileProvider extends H.map.provider.Provider {
     ...
     */
    protected abstract createTileInternal (x : number , y : number , z : number , data : HTMLImageElement | null | HTMLCanvasElement | GlobalObject , opt_options ? : { [ key: string ]: any } | null ) : H.map.provider.Tile | null ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached tiles are to be considered (`true`) or not (`false`)
     */
    abstract requestTile (x : number , y : number , z : number , cacheOnly : boolean ) : H.map.provider.Tile | null | undefined ;
    /**
...
declare namespace H.map.provider.TileProvider {
  type Options = { getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , max ? : number , min ? : number , tileSize ? : number , uri ? : string } ;
}
declare namespace H.map.render {
  ...
  interface ICapabilities {
     ...
     */
    interaction : GlobalObject | null | boolean ;
    /**
...
declare namespace H.map.render {
   ...
   */
  abstract class RenderEngine extends H.util.EventTarget {
    /**
     * This is an abstract class representing a render engine.
     * Render engines are used to render the geographical position from a view model on the screen (viewport element).
     * The rendered result may be different for different engines,
     ...
     */
    constructor (viewPort : H.map.ViewPort | null , viewModel : H.map.ViewModel | null , dataModel : H.map.DataModel | null , options : H.map.render.RenderEngine.Options ) ;
  }
}
...
declare namespace H.map.render {
   ...
   */
  type RenderingParams = { boundingBox : H.geo.Rect | null , cacheOnly : boolean , pixelRatio : number , priorityCenter : H.math.Point | null , projection : H.geo.PixelProjection | null , screenCenter : H.math.Point | null , size : H.math.Size | null , zoom : number } ;
}
declare namespace H.map.render {
  /**
...
declare namespace H.map.render.p2d.RenderEngine {
  type Options = { enableSubpixelRendering ? : boolean , pixelRatio : number , renderBaseBackground ? : GlobalObject | null } ;
}
declare namespace H.map.render.webgl {
   ...
   */
  type StyleConfig = { globals ? : GlobalObject | null , layers ? : GlobalObject | null , scene ? : GlobalObject | null , sources ? : GlobalObject | null , textures ? : GlobalObject | null } ;
}
declare namespace H.map.render.webgl {
  /**
  ...
  class RenderEngine extends H.map.render.RenderEngine {
     ...
     */
    geoToMeters (geoPoint : H.geo.IPoint | null ) : { x : number , y : number , z : number | null } ;
    /**
     * This method retrieves the current setting indicating the length of
     * animations (duration) run by the the render engine.
     */
     ...
     */
    metersToGeo (point : { x : number , y : number , z : number | null } ) : H.geo.IPoint | null ;
    /**
     * This method resets animation settings on the render engine to defaults.
     * `duration` is set to 300ms and easing to {@link H.util.animation.ease.EASE_OUT_QUAD}.
     */
    resetAnimationDefaults ( ) : void ;
    /**
     * This method sets the length (duration) for all animations run by the render engine.
...
declare namespace H.map.render.webgl {
  ...
  class Style extends H.map.render.Style < any > {
     ...
     */
    setInteractive (layerIds : string | string [] | null , interactive : boolean , opt_recursive ? : boolean ) : void ;
    /**
     ...
     */
    setProperty (path : string , value : string | number | GlobalObject | null | boolean , opt_force ? : boolean ) : void ;
    /**
...
declare namespace H.mapevents {
  ...
  class Behavior extends H.util.Disposable {
     ...
     */
    constructor (mapEvents : H.mapevents.MapEvents | null , options ? : H.mapevents.Behavior.Options ) ;
    /**
...
declare namespace H.mapevents.Behavior {
  ...
  type Options = { enabled ? : number , kinetics ? : H.util.kinetics.IKinetics | null , modifierKey ? : string } ;
}
declare namespace H.mapevents {
  /**
  ...
  class ContextMenuEvent extends H.util.Event {
     ...
     */
    constructor (viewportX : number , viewportY : number , target : H.Map | null | H.map.Object , originalEvent : GlobalEvent | null ) ;
    /**
     ...
     */
    items : ( H.util.ContextItem | null ) [] | null ;
    /**
     * This property holds the original event.
     */
    originalEvent : GlobalEvent | null ;
    /**
...
declare namespace H.mapevents {
  ...
  class Event extends H.util.Event {
     ...
     */
    constructor (type : string , pointers : ( H.mapevents.Pointer | null ) [] | null , changedPointers : ( H.mapevents.Pointer | null ) [] | null , targetPointers : ( H.mapevents.Pointer | null ) [] | null , currentPointer : H.mapevents.Pointer | null , target : H.Map | null | H.map.Object , originalEvent : GlobalEvent | null ) ;
    /**
     * This property holds an array of pointers that have changed in course of event.
     */
    changedPointers : ( H.mapevents.Pointer | null ) [] | null ;
    /**
     * This property holds the current pointer.
     */
    currentPointer : H.mapevents.Pointer | null ;
    /**
     ...
     */
    pointers : ( H.mapevents.Pointer | null ) [] | null ;
    /**
     ...
     */
    targetPointers : ( H.mapevents.Pointer | null ) [] | null ;
  }
}
declare namespace H.mapevents {
  /**
...
declare namespace H.mapevents.Pointer {
  /**
   * This enumeration defines identifiers for button types.
   */
  enum Button {
    LEFT = 0.0 ,
    MIDDLE = 1.0 ,
...
declare namespace H.mapevents {
  ...
  class WheelEvent extends H.util.Event {
     ...
     * @param originalEvent An object representing the original event
     */
    constructor (deltaY : number , viewportX : number , viewportY : number , target : H.Map | null | H.map.Object , originalEvent : GlobalEvent | null ) ;
    /**
...
declare namespace H.math {
  ...
  class Point implements H.math.IPoint {
     ...
     */
    distance (other : H.math.IPoint | null ) : number ;
    /**
     ...
     */
    getNearest (start : H.math.IPoint | null , end : H.math.IPoint | null ) : H.math.IPoint | null ;
    /**
     * This method rounds the x and y coordinates of the given point.
     */
    round ( ) : H.math.Point | null ;
    /**
     ...
     */
    scale (factor : number , opt_factorY ? : number ) : H.math.Point | null ;
    /**
     ...
     */
    sub (other : H.math.IPoint | null ) : H.math.Point | null ;
    /**
     * This method creates a `Point` instance from the `IPoint` object
     * provided by the caller.
     * @param iPoint An object implementing `IPoint`
     */
    static fromIPoint (iPoint : H.math.IPoint | null ) : H.math.Point | null ;
  }
}
declare namespace H.math {
  /**
  ...
  class Rect {
     ...
     */
    getBottomRight ( ) : H.math.Point | null ;
    /**
     * This method retrieves the top-left vertex of the rectangle.
     */
    getTopLeft ( ) : H.math.Point | null ;
    /**
     ...
     */
    static fromPoints (topLeft : H.math.IPoint | null , bottomRight : H.math.IPoint | null ) : H.math.Rect | null ;
  }
}
declare namespace H.math {
  /**
...
declare namespace H.service {
  /**
   * This property specifies the map type.
   * A map type is an object holding tile layers corresponding to a map type ('normal', 'satellite' or 'terrain').
   * A map type contains at least a `map` property which defines the basic map layer for a given map type.
   * In addition, it can contain other map layers, for example `base`, `xbase`, `trafficincidents`, etc.
   */
  type MapType = { base : H.map.layer.TileLayer | null , basenight ? : H.map.layer.TileLayer | null , labels : H.map.layer.TileLayer | null , map : H.map.layer.TileLayer | null , mapnight ? : H.map.layer.TileLayer | null , trafficincidents ? : H.map.layer.MarkerTileLayer | null , transit ? : H.map.layer.TileLayer | null , xbase : H.map.layer.TileLayer | null , xbasenight ? : H.map.layer.TileLayer | null } ;
  /**
   ...
   */
  type ServiceParameters = GlobalObject | null ;
  /**
   ...
   */
  type ServiceResult = GlobalObject | null ;
  /**
   * This type represents a handle object.
   */
  type JsonpRequestHandle = GlobalObject | null ;
  /**
   * This type defines options which are used to initialize a tile provider.
   */
  type TileProviderOptions = { crossOrigin ? : string | null , headers ? : GlobalObject | null } ;
}
declare namespace H.service {
  /**
   * This property specifies collection of pre-configured HERE layers.
   */
  type DefaultLayers = { raster : { normal : H.service.MapType , satellite : H.service.MapType , terrain : H.service.MapType } , vector : { normal : { map : H.map.layer.TileLayer | null , traffic : H.map.layer.TileLayer | null , trafficincidents : H.map.layer.MarkerTileLayer | null , truck : H.map.layer.TileLayer | null } } } ;
}
declare namespace H.service {
  /**
  ...
  class GeocodingService extends H.service.Service {
     ...
     */
    geocode (geocodingParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request
     */
    reverseGeocode (reverseGeocodingParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request
     */
    search (searchParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.service.GeocodingService {
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , reverseSubDomain ? : string , subDomain ? : string } ;
}
declare namespace H.service {
  /**
  ...
  class MapTileService extends H.service.Service {
     ...
     */
    createTileLayer (tileType : string , scheme : string , tileSize : number , format : string , opt_additionalParameters ? : GlobalObject | null , opt_opacity ? : number , opt_dark ? : boolean , opt_options ? : H.service.TileProviderOptions ) : H.map.layer.TileLayer | null ;
    /**
     ...
     */
    createTileProvider (tileType : string , scheme : string , tileSize : number , format : string , opt_additionalParameters ? : GlobalObject | null , opt_options ? : H.service.TileProviderOptions ) : H.map.provider.ImageTileProvider | null ;
    /**
...
declare namespace H.service.MapTileService {
  type Info = { formats : { [ key: string ]: GlobalObject | null } | null , languages : { [ key: string ]: GlobalObject | null } | null , maps : { [ key: string ]: GlobalObject | null } | null , resolutions : { [ key: string ]: GlobalObject | null } | null , schemes : { [ key: string ]: GlobalObject | null } | null , tiletypes : { [ key: string ]: GlobalObject | null } | null } ;
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , path ? : string , shards ? : any [] | null , subDomain ? : string , type ? : string , version ? : string } ;
}
declare namespace H.service {
  /**
   * This service is no longer being actively developed.
  ...
  class PlacesService extends H.service.Service {
     ...
     */
    constructor (opt_options ? : H.service.extension.customLocation.Service.Options ) ;
    /**
     ...
     */
    around (aroundParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback which is called when an error occurs
     */
    categories (categoriesParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback which is called when an error occurs
     */
    explore (exploreParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     */
    follow (hyperlink : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_additionalParameters ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback which is called when an error occurs
     */
    here (hereParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     */
    request (entryPoint : string , entryPointParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback which is called when an error occurs
     */
    suggest (suggestParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.PlacesService {
  ...
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
declare namespace H.service {
  /**
  ...
  class Platform {
     ...
     * It returns an object with the following sections:
     *
     * - `vector`
     * - `normal`
     * - `map`              {@link H.map.layer.TileLayer}       Vector tiles with HERE Optimized Map Visualization (OMV) data
     * - `truck`            {@link H.map.layer.TileLayer}       Vector tiles with HERE Optimized Map Visualization (OMV) data and truck map scheme
     * - `traffic`          {@link H.map.layer.TileLayer}       Traffic flow information as vector data
     * - `trafficincidents` {@link H.map.layer.MarkerTileLayer} Traffic incidents as markers data
     * - `raster`
     * - `normal`
     * - `map`              {@link H.map.layer.TileLayer}       Basic map tiles with all features and labels
     * - `mapnight`         {@link H.map.layer.TileLayer}       Basic map tiles with all features and labels (night mode)
     * - `xbase`            {@link H.map.layer.TileLayer}       Map tiles without features and labels
     * - `xbasenight`       {@link H.map.layer.TileLayer}       Map tiles without features and labels (night mode)
     * - `base`             {@link H.map.layer.TileLayer}       Map tiles without labels
     * - `basenight`        {@link H.map.layer.TileLayer}       Map tiles without labels (night mode)
     * - `trafficincidents` {@link H.map.layer.MarkerTileLayer} Map markers with traffic incidents
     * - `transit`          {@link H.map.layer.TileLayer}       Map tiles with public transit lines
     * - `labels`           {@link H.map.layer.TileLayer}       Transparent map tiles with labels only
     * - `satellite`
     * - `map`              {@link H.map.layer.TileLayer}
     * - `xbase`            {@link H.map.layer.TileLayer}
     * - `base`             {@link H.map.layer.TileLayer}
     * - `labels`           {@link H.map.layer.TileLayer}
     * - `terrain`
     * - `map`              {@link H.map.layer.TileLayer}
     * - `xbase`            {@link H.map.layer.TileLayer}
     * - `base`             {@link H.map.layer.TileLayer}
     * - `labels`           {@link H.map.layer.TileLayer}
     * @param opt_tileSize If this parameter is a number, it indicates the tile size to be queried from the HERE Map Tile API (the default value is `512`); if this parameter is an object, it represents configuration options for the layer and all the remaining parameters (below) should be omitted
     * @param opt_ppi An optional 'ppi' parameter to use when querying tiles, the default is not specified. See [Base Map Tile – Optional Query Parameters](https://developer.here.com/documentation/map-tile/dev_guide/topics/resource-base-basetile.html#resource-base-basetile__includes-query-parameters) for more details
     ...
     * @param opt_pois A Boolean value indicating if POIs are displayed on the map (`true`) or a mask for the POI Categories as described in the Map Tile API documentation [POI Categories](https://developer.here.com/documentation/map-tile/dev_guide/topics/resource-meta-pois.html). By default POIs are disabled.
     */
    createDefaultLayers (opt_tileSize ? : H.service.Platform.DefaultLayersOptions | number , opt_ppi ? : number , opt_lang ? : string , opt_secondaryLang ? : string , opt_style ? : string , opt_pois ? : string | boolean ) : H.service.DefaultLayers ;
    /**
     ...
     */
    createService (Service : { new (a : GlobalObject | null ) : GlobalObject } , opt_options : GlobalObject | null ) : GlobalObject | null ;
    /**
     ...
     * [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) API.
     * @param opt_options Configuration options for CLE service
     */
    ...
    /**
     * Returns a new instance of {@link H.service.extension.customRoute.Service} to query the
     * [Custom Route Extension API](
     * https://developer.here.com/documentation/custom-routing-extension/dev_guide/topics/request-constructing.html).
     * @param opt_options Configuration options for custom route service
     */
     ...
     */
    getGeofencingService (opt_options ? : H.service.extension.customLocation.Service.Options ) : H.service.extension.geofencing.Service ;
    /**
     ...
     */
    getMetaInfoService (opt_options ? : H.service.metaInfo.Service.Options ) : H.service.metaInfo.Service | null ;
    /**
     ...
     * [Platform Data Extension API](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html).
     * @param opt_options Configuration options for PDE service
     */
    getPlatformDataService (opt_options ? : H.service.extension.customLocation.Service.Options ) : H.service.extension.platformData.Service ;
    /**
     ...
     */
    getPublicTransitService (opt_options ? : H.service.extension.customRoute.Service.Options ) : H.service.publicTransit.Service ;
    /**
     * To create a new instance of {@link H.service.RoutingService} to query the selected Routing API.
     * For the compatibility reasons the class defaults to the deprecated
     ...
     */
    getRoutingService (opt_options ? : H.service.extension.customLocation.Service.Options , opt_version ? : number ) : H.service.RoutingService | H.service.RoutingService8 ;
    /**
     ...
     */
    getSearchService (opt_options ? : H.service.extension.customLocation.Service.Options ) : H.service.SearchService ;
    /**
     * This method returns an instance of {@link H.service.traffic.Service} to query the
     * [Traffic API](https://developer.here.com/documentation/traffic/dev_guide/topics/resources.html)
     * [Traffic Incident Data](https://developer.here.com/documentation/traffic/dev_guide/topics/incident-data.html)
    ...
    /**
     * This method returns an instance of {@link H.service.xyz.Service} to query the
     * [HERE XYZ Hub](https://developer.here.com/documentation/studio/).
     * @param options Configuration options for XYZ service.
     */
    getXYZService (options : H.service.xyz.Service.Options ) : H.service.xyz.Service ;
    /**
     * To set the base URL to be used when creating service stubs.
     * @param baseUrl The new base URL to use
     */
    setBaseUrl (baseUrl : H.service.Url | null ) : void ;
  }
}
declare namespace H.service.Platform {
  type DefaultLayersOptions = { crossOrigin ? : string | null , lg ? : string , lg2 ? : string , pois ? : boolean , ppi ? : number , style ? : string , tileSize ? : number } ;
  type Options = { apikey : string , baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , servicesConfig ? : GlobalObject | null } ;
}
declare namespace H.service {
  /**
   * This service is no longer being actively developed.
  ...
  class RoutingService extends H.service.Service {
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    calculateIsoline (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    calculateRoute (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.RoutingService {
  /**
   * This type encapsulates configuration (initialization) options for an instance of `RoutingService`.
   */
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
declare namespace H.service {
...
declare namespace H.service {
  ...
  class SearchService extends H.service.Service {
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    autosuggest (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    browse (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    discover (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    geocode (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    lookup (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    reverseGeocode (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.SearchService {
  /**
   * This type encapsulates configuration (initialization) options for an instance of `SearchService`.
   */
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
declare namespace H.service {
  ...
  abstract class Service extends H.util.EventTarget {
     ...
     */
    constructor (constructor : Function | null , opt_options ? : GlobalObject | null ) ;
    /**
     * This method returns the configured service URL.
     */
    getUrl ( ) : H.service.Url | null ;
  }
}
declare namespace H.service {
  /**
  ...
  class Url {
     ...
     */
    constructor (scheme : string , host : string , opt_path ? : string , opt_params ? : GlobalObject | null , opt_port ? : number , opt_anchor ? : string ) ;
    /**
     ...
     */
    addSubDomain (subDomain : string ) : H.service.Url | null ;
    /**
     * This method adds a sub-path to the given `Url`'s path.
     * @param subPath The path to be added
     */
    addSubPath (subPath : string ) : H.service.Url | null ;
    /**
     ...
     */
    setPath (path : string | undefined ) : H.service.Url | null ;
    /**
     ...
     */
    setQuery (params : GlobalObject | null | undefined ) : H.service.Url | null ;
    /**
     * This method sets the scheme of the given URL object.
     * @param scheme The new scheme
     */
    setScheme (scheme : string ) : H.service.Url | null ;
    /**
     ...
     */
    static parse (url : string , opt_baseURL ? : string ) : H.service.Url | null ;
  }
}
declare namespace H.service.Url {
  class MultiValueQueryParameter {
     ...
     */
    constructor (values : ( string | number ) [] | null ) ;
    /**
...
declare namespace H.service.extension {
   ...
   * from the PDE/CLE response. The ID of the according layer is passed as second argument.
   * Return true to keep the row, otherwise false.
   *
   * It must not modify the row! It must be a pure JavaScript function.
   */
  type RowFilter = (a : H.service.extension.dataView.IRow < any , any > | null , b : string ) => boolean ;
}
declare namespace H.service.extension {
  /**
   * This is an abstract provider for continuous fetching of data provided by the HERE Platform Extensions.
...
declare namespace H.service.extension.TileProvider {
  type Options = { max ? : number , min ? : number , pixelRatio ? : number , resultType : H.service.extension.TileProvider.ResultType , styleCallback ? : H.service.extension.TileProvider.StyleCallback , tileCacheSize ? : number , tileSize ? : number , uri ? : string } ;
  /**
  ...
  type StyleCallback = (a : H.service.extension.dataView.IRow < any , any > | null ) => H.map.Icon | null | H.map.DomIcon | H.map.SpatialStyle.Options ;
}
declare namespace H.service.extension.customLocation {
  /**
   * A LayerConfig is an object that contains a configuration for a CLE data layer.
   */
  type LayerConfig = { columns : string [] | null , layerId : string , rowFilter ? : H.service.extension.RowFilter , rowFilterContext ? : GlobalObject | null } ;
}
declare namespace H.service.extension.customLocation {
  /**
   * An object that contains access permissions for a CLE data layer that are granted for a specified Application ID.
   * See [Grant other app_ids Access to Geometry Layers
   * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-layers-grant.html)
   * for more details.
   */
...
declare namespace H.service.extension.customLocation {
  /**
   * The access permissions types which can be granted to other App-IDs.
   * See [Grant other apikey Access to Geometry Layers
   * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-layers-grant.html)
   * for more details.
   */
  /**
...
declare namespace H.service.extension.customLocation {
   ...
   * [Custom Location Extension API](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) ("CLE")
  ...
  class Service extends H.service.Service {
    ...
    constructor (opt_options ? : H.service.extension.customLocation.Service.Options ) ;
    /**
     * To append rows to [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layers.
     ...
     */
    appendRows (rows : H.service.extension.customLocation.Table.Row [] , onResult : (a : H.service.extension.customLocation.Table.Row [] , b : boolean ) => any , onError : (a : Error | null , b : H.service.extension.customLocation.Table.Row [] , c : boolean ) => any ) : H.util.ICancelable | null ;
    /**
     * To create a new data layer on the
     * [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) backend and to provide a `Table`
     * instance, that represents the created layer, to work with.
     ...
     */
    createLayer (metaInfo : H.service.extension.customLocation.MetaInfo , onResult : (a : H.service.extension.customLocation.Table | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To create a tile layer which can be added to the map in order to visualize data from the specified
     * [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer.
     * @param layerConfig The configuration for the data layer to load.
     * @param options The options to configure the tile provider.
     */
    createTileLayer (layerConfig : H.service.extension.customLocation.LayerConfig , options : H.service.extension.TileProvider.Options ) : H.map.layer.TileLayer | null | H.map.layer.MarkerTileLayer ;
    /**
     * To delete an existing data layer from the
     * [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) backend.
     * @param layerId The ID of the data layer to delete.
     * @param onResult The callback to invoke if the layer could be deleted.
     * @param onError The callback to invoke if an error occurs.
     */
    deleteLayer (layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To delete rows from [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer.
     * @param rows The data rows to delete. All rows must have a defined GEOMETRY_ID cell.
     * @param onResult The callback to invoke when a chunk is processed. The following arguments are passed: <ul> <li> The list of processed rows. </li> <li>An indicator whether it's the last chunk.</li> </ul>
     * @param onError The callback to invoke when an error occurred. The following arguments are passed: <ul> <li> The occurred error. </li> <li> The list of rows of the chunk which caused the error. </li> <li>An indicator whether it's the last chunk.</li> </ul>
     */
    deleteRows (rows : H.service.extension.customLocation.Table.Row [] , onResult : (a : H.service.extension.customLocation.Table.Row [] , b : boolean ) => any , onError : (a : Error | null , b : H.service.extension.customLocation.Table.Row [] , c : boolean ) => any ) : H.util.ICancelable | null ;
    /**
     * To fetch the meta information for a data layer from the
     * [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) backend and create a `Table`
     * instance, that represents the requested layer, to work with.
     ...
     * @param onError The callback to invoke if an error occurs.
     */
    getLayer (layerId : string , onResult : (a : H.service.extension.customLocation.Table | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To set the rights for other APP-IDs to access a CLE data layer.
     * See [Grant other apikey Access to Geometry Layers
     * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-layers-grant.html)
     * for more details.
     ...
     * @param onError The callback to invoke if an error occurs.
     */
    grantAccess (layerId : string , grants : H.service.extension.customLocation.Grant [] , onResult : (a : H.service.extension.customLocation.Table | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * This method sends a request to a resource with the provided name and type from the [Custom Location Extension API](
     * https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html).
     * For available types see
     * [Constructing a Request](
     * https://developer.here.com/documentation/custom-location/dev_guide/topics/request-constructing.html).
     * @param entryPoint The entry point of the [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/request-constructing.html) API.
     * @param entryPointType The type of the response for the entry point.
     ...
     */
    request (entryPoint : H.service.extension.customLocation.Service.EntryPoint , entryPointType : H.service.extension.customLocation.Service.EntryPointType , params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To search for [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer entries
     * It's possible to limit the resulting entries by different query parameters (see `opt_params` argument).
     * See [Attribute Search and Layer Download
     * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-search-all.html)
     * for more details).
     * @param layerId The ID of the data layer to download.
     * @param onResult The callback to invoke when a chunk of data is received. The following arguments are passed: <ol> <li> The list of received entries of the [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer. </li> <li>An indicator whether it's the last chunk.</li> </ol>
     ...
     */
    searchAll (layerId : string , onResult : (a : ( H.service.extension.customLocation.Table.Row | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer entries
     * within a rectangular geographical area.
     * See [Bounding Box Search
     * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-search-bounding-box.html)
     * for more details.
     ...
     * @param opt_params A key-value map of query parameters to use for the search. A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByBoundingBox (layerIds : string [] | null , boundingBox : H.geo.Rect | null , onResult : (a : ( H.service.extension.customLocation.Table.Row | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer entries
     * that are within a given radius along a polyline.
     * See [Corridor Polygon Search
     * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-search-corridor.html)
     * for more details.
     * @param layerIds The IDs of the layers to search in.
     ...
     * @param opt_params A key-value map of query parameters to use for the search. A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByCorridor (layerIds : string [] | null , corridor : H.geo.LineString | null | string , radius : number , onResult : (a : ( H.service.extension.customLocation.Table.Row | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer entries
     * that are within a given radius around a geographical center.
     * See [Proximity Search
     * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-search-proximity.html)
     * for more details.
     * @param layerIds The IDs of the layers to search in.
     ...
     * @param onResult The callback to invoke when a chunk of data is received. The following arguments are passed: <ol> <li> The list of received entries of the [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layer. </li> <li>An indicator whether it's the last chunk.</li> </ol>
     * @param onError The callback to invoke when an error occurred.
     * @param opt_params A key-value map of query parameters to use for the search (see [CLE documentation ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-search-proximity.html) for more details). A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByProximity (layerIds : string [] | null , center : H.geo.Point | null , radius : number , onResult : (a : ( H.service.extension.customLocation.Table.Row | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To update rows of [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/what-is.html) data layers.
     * @param rows The data rows to update. All rows must have an defined GEOMETRY_ID cell.
     * @param onResult The callback to invoke when a chunk is processed. The following arguments are passed: <ul> <li> The list of processed rows. </li> <li>An indicator whether it's the last chunk.</li> </ul>
     * @param onError The callback to invoke when an error occurred. The following arguments are passed: <ul> <li> The occurred error. </li> <li> The list of rows of the chunk which caused the error. </li> <li>An indicator whether it's the last chunk.</li> </ul>
     */
    updateRows (rows : H.service.extension.customLocation.Table.Row [] , onResult : (a : H.service.extension.customLocation.Table.Row [] , b : boolean ) => any , onError : (a : Error | null , b : H.service.extension.customLocation.Table.Row [] , c : boolean ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.extension.customLocation.Service {
  /**
   * List of available [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/request-constructing.html) entry points.
   */
  enum EntryPoint {
  ...
  /**
   * The available types for [CLE](https://developer.here.com/documentation/custom-location/dev_guide/topics/request-constructing.html)
   * entry points.
   * Not all entry points support all types, for reference see [Constructing a Request
   * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/request-constructing.html) for
   * more details.
   */
  enum EntryPointType {
    JSON = 'json' ,
...
declare namespace H.service.extension.customLocation {
  /**
   * The storage type of a CLE data layer.
   * See [Import Geometries in a WKT or Shape File
   * ](https://developer.here.com/documentation/custom-location/dev_guide/topics/resource-upload.html)
   * for more details.
   */
  /**
   * The storage type of a CLE data layer.
...
declare namespace H.service.extension.customLocation {
  /**
   * This class represents a CLE data layer as a table.
  ...
  class Table implements H.service.extension.dataView.ITable < any , any > {
     ...
     */
    addCells (cells : ( string | null | H.geo.AbstractGeometry ) [] ) : number ;
    /**
     * To add a new row at the bottom of the table.
     * All cells of the row are initialized with a `null` value.
     */
    addRow ( ) : H.service.extension.customLocation.Table.Row | null ;
    concat (var_args ? : any ) : any ;
    getCell (rowIndex ? : any , columnName ? : any ) : any ;
    getColumn (columnName ? : any ) : any ;
    getColumnNames ( ) : any ;
    getMeta ( ) : any ;
    getRow (rowIndex ? : any ) : any ;
    getRowCount ( ) : any ;
    /**
...
declare namespace H.service.extension.customLocation.Table {
  /**
   * This class represents values of an specific attribute within a CLE layer as a table column.
...
declare namespace H.service.extension.customLocation.Table {
  /**
   * This class represents an record within a CLE data layer as a table row.
  ...
  class Row implements H.service.extension.dataView.IRow < any , any > {
    ...
    getTable ( ) : H.service.extension.dataView.ITable < any , any > | null ;
    /**
...
declare namespace H.service.extension.customLocation {
  /**
   * This class represents a provider for continuous fetching of data by tiles from a data layer of the
  ...
  class TileProvider extends H.service.extension.TileProvider {
     ...
     * {@link H.service.extension.dataView.IRow} and can be retrieved by calling
     * {@link H.map.Object#getData} method.
     * @param service An object representing the CLE service
     * @param layerConfig The configuration options of the data layer
     * @param options Contains configuration options. By default 'min' option is `12`. If the data layer is stored on higher storage levels, decreasing minimum zoom level might slow down the browser due to the enormous amount of necessary requests to load all tiles of the data layer that intersects with the visible geographic area. For example if storage level is 10, in order to load an area covering North America on zoom level 4 more than 200.000 requests are required. More information about storage levels can be found in [CLE Documentation](https://developer.here.com/documentation/custom-location/dev_guide/topics/key-concepts.html).
     */
    constructor (service : H.service.extension.customLocation.Service | null , layerConfig : H.service.extension.customLocation.LayerConfig , options : H.service.extension.TileProvider.Options ) ;
    requestInternal (x : number , y : number , z : number , onSuccess : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
  }
}
declare namespace H.service.extension.customRoute {
  /**
   * This class encapsulates the [Custom Route Extension API](
   * https://developer.here.com/documentation/custom-routing-extension/dev_guide/topics/what-is.html)
   * in a service stub, providing methods to access its resources.
   * Refer to the REST service documentation for the description of service parameters and response objects.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
  ...
  class Service extends H.service.Service {
     ...
     * @param opt_options Configuration options for custom route service
     */
    constructor (opt_options ? : H.service.extension.customRoute.Service.Options ) ;
    /**
     * This method sends a route calculation request to the [Custom Route Extension API](
     * https://developer.here.com/documentation/custom-routing-extension/dev_guide/topics/what-is.html) and
     * calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error occurred.
     *
     * Please refer to the
     * [API Documentation](https://developer.here.com/documentation/custom-routing-extension/dev_guide/topics/resource-calculateroute.html)
     * for information on available parameters and the response object structure.
...
declare namespace H.service.extension.customRoute.Service {
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
...
declare namespace H.service.extension.dataView {
  /**
   * An interface to provide access to two-dimensional rectangular data structures such as PDE and CLE data.
   * It uses two generic types:
   * <ul>
   * <li><code>C</code>: The type for all cell values</li>
...
declare namespace H.service.extension.geofencing {
  /**
   * This class encapsulates the [Geofencing Extension API](
   * https://developer.here.com/documentation/geofencing/dev_guide/topics/what-is.html)
   * in a service stub, providing methods to access its resources.
   * Refer to the REST service documentation for the description of service parameters and response objects.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
  ...
  class Service extends H.service.Service {
     ...
     * https://developer.here.com/documentation/geofencing/dev_guide/topics/what-is.html).
     * @param entryPoint The entry point of the [GFE](https://developer.here.com/documentation/geofencing/dev_guide/topics/what-is.html) API.
     * @param params A key-value map of query parameters to use for the request.
     * @param onResult The callback which is called when result is returned
     * @param onError The callback which is called when error occurred (i.e request timeout, or server error)
     */
    request (entryPoint : H.service.extension.geofencing.Service.EntryPoint , params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.extension.geofencing.Service {
  /**
   * List of available
   * [GFE](https://developer.here.com/documentation/geofencing/dev_guide/topics/what-is.html) entry points.
   * At the moment only
   * [search/proximity](https://developer.here.com/documentation/geofencing/dev_guide/topics/resource-search-proximity-request.html)
...
declare namespace H.service.extension.platformData {
  /**
   * The PDE layer configuration options.
   */
  type LayerConfig = { columns : string [] | null , layerId : string , level : number , rowFilter ? : H.service.extension.RowFilter , rowFilterContext ? : GlobalObject | null } ;
}
declare namespace H.service.extension.platformData {
  /**
   * This class encapsulates the
   * [Platform Data Extension API](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) ("PDE")
   * in a service stub, providing methods to access its resources.
   * Refer to the REST service documentation for the description of service parameters and response
   * objects.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
  ...
  class Service extends H.service.Service {
     ...
     * continuously fetch data for the specified layer from the
     * [Platform Data Extension API](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html).
     ...
     */
    createTileLayer (layerConfig : H.service.extension.platformData.LayerConfig , options : H.service.extension.TileProvider.Options ) : H.map.layer.TileLayer | null | H.map.layer.MarkerTileLayer ;
    /**
     * This method sends a request to a resource with the provided name and type from the [Platform Data Extension API](
     * https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html).
     * For available types see
     * [Constructing a Request](
     * https://developer.here.com/documentation/platform-data/dev_guide/topics/request-constructing.html).
     * @param entryPoint The entry point of the Platform Data Extension API.
     * @param entryPointType The type of the response for the entry point
     * @param params A key-value map of query parameters to use for the request.
     * @param onResult The callback which is called when result is returned
     * @param onError The callback which is called when error occurred (i.e request timeout)
     */
    request (entryPoint : H.service.extension.platformData.Service.EntryPoint , entryPointType : H.service.extension.platformData.Service.EntryPointType , params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To search for [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer entries
     * within a rectangular geographical area.
     * See [Bounding Box Search](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-bbox.html)
     * for more details.
     * @param layerIds The IDs of the layers to search in.
     ...
     * @param boundingBox The geographical area where to search.
     * @param onResult The callback to invoke when a chunk of data is received. The following arguments are passed: <ol> <li> The list of received entries of the [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer. </li> <li>An indicator whether it's the last chunk.</li> </ol>
     * @param onError The callback to invoke when an error occurred.
     * @param opt_params A key-value map of query parameters to use for the search (see [PDE documentation](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-bbox.html) for more details). A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByBoundingBox (layerIds : any [] | null , keyAttributes : any [] | null , boundingBox : H.geo.Rect | null , onResult : (a : ( H.service.extension.dataView.IRow < any , any > | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer entries
     * that are within a given radius along a polyline.
     * See [Corridor Polygon Search](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-corridor.html)
     * for more details.
     * @param layerIds The IDs of the layers to search in.
     * @param keyAttributes The list of the key columns, one for each layer, ordered according to the order of the layers in the `layerIds` argument. The key column is used to identify all entry fragments (stored on different tiles within the database) that belong to an identical entry.
     * @param corridor The center line of the corridor. Either defined as a {@link H.geo.LineString} or as a `RouteId` string that was obtained from a previous Router call. See {@link H.service.RoutingService#calculateRoute} or [Routing API CalculateRouteResponseType](https://developer.here.com/documentation/routing/dev_guide/topics/resource-type-calculate-route.html).
     ...
     * @param onResult The callback to invoke when a chunk of data is received. The following arguments are passed: <ol> <li> The list of received entries of the [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer. </li> <li>An indicator whether it's the last chunk.</li> </ol>
     * @param onError The callback to invoke when an error occurred.
     * @param opt_params A key-value map of query parameters to use for the search (see [PDE documentation](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-corridor.html) for more details). A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByCorridor (layerIds : string [] | null , keyAttributes : string [] | null , corridor : H.geo.LineString | null | string , radius : number , onResult : (a : ( H.service.extension.dataView.IRow < any , any > | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer entries
     * that are within a given radius around a geographical center.
     * See [Proximity Search](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-proximity.html)
     * for more details.
     * @param layerIds The IDs of the layers to search in.
     * @param keyAttributes The list of the key columns, one for each layer, ordered according to the order of the layers in the `layerIds` argument. The key column is used to identify all entry fragments (stored on different tiles within the database) that belong to an identical entry.
     * @param center The geographical point to search around.
     ...
     * @param onResult The callback to invoke when a chunk of data is received. The following arguments are passed: <ol> <li> The list of received entries of the [PDE](https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html) data layer. </li> <li>An indicator whether it's the last chunk.</li> </ol>
     * @param onError The callback to invoke when an error occurred.
     * @param opt_params A key-value map of query parameters to use for the search (see [PDE documentation](https://developer.here.com/documentation/platform-data/dev_guide/topics/resource-search-proximity.html) for more details). A query parameter has a higher priority than a value provided by an according method argument.
     */
    searchByProximity (layerIds : string [] | null , keyAttributes : string [] | null , center : H.geo.Point | null , radius : number , onResult : (a : ( H.service.extension.dataView.IRow < any , any > | null ) [] | null , b : boolean ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.extension.platformData.Service {
  ...
  /**
   * List of available types for entry points.
   * Not all entry points support all types, for reference see
   * [Constructing a Request](
   * https://developer.here.com/documentation/platform-data/dev_guide/topics/request-constructing.html).
   */
  enum EntryPointType {
...
declare namespace H.service.extension.platformData {
  /**
   * An object to provide read access to the rows, columns and cells of a PDE layer. The type definition
   * implements {@link H.service.extension.dataView.ITable} interface
   */
  type Table = H.service.extension.dataView.ITable < string | ( Uint16Array | GlobalFloat32Array ) [] | null , { [ key: string ]: any } | undefined > | null ;
}
declare namespace H.service.extension.platformData {
  /**
   * This class represents a provider for continuous fetching of data by tiles from a data layer of the
   * [Platform DataExtension API](
   * https://developer.here.com/documentation/platform-data/dev_guide/topics/what-is.html).
   *
  ...
  class TileProvider extends H.service.extension.TileProvider {
     ...
     * {@link H.service.extension.dataView.IRow} and can be retrieved by calling
     * {@link H.map.Object#getData} method.
     * @param service An object representing the PDE service
     ...
     */
    constructor (service : H.service.extension.platformData.Service | null , layerConfig : H.service.extension.platformData.LayerConfig , options : H.service.extension.TileProvider.Options ) ;
    requestInternal (x : number , y : number , z : number , onSuccess : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
  }
}
...
declare namespace H.service.metaInfo {
  ...
  class Service extends H.service.Service {
     ...
     */
    createTileLayer (tileSize : number , pixelRatio : number , opt_categoryFilter ? : string [] | null , opt_additionalParameters ? : GlobalObject | null , opt_tileType ? : string , opt_scheme ? : string ) : H.map.layer.TileLayer | null ;
    /**
     ...
     * @param opt_scheme The scheme for which the meta info tiles a requested (default is `"normal.day"`)
     */
    createTileProvider (tileSize : number , pixelRatio : number , opt_categoryFilter ? : string [] | null , opt_additionalParameters ? : GlobalObject | null , opt_tileType ? : string , opt_scheme ? : string ) : H.map.provider.TileProvider | null ;
    /**
...
declare namespace H.service.metaInfo.Service {
  type Info = { formats : { [ key: string ]: GlobalObject | null } | null , languages : { [ key: string ]: GlobalObject | null } | null , maps : { [ key: string ]: GlobalObject | null } | null , resolutions : { [ key: string ]: GlobalObject | null } | null , schemes : { [ key: string ]: GlobalObject | null } | null , tiletypes : { [ key: string ]: GlobalObject | null } | null } ;
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , path ? : string , subDomain ? : string , type ? : string , version ? : string } ;
}
declare namespace H.service.metaInfo {
  /**
   * This class utilizes
  ...
  class TileProvider extends H.map.provider.RemoteTileProvider {
     ...
     */
    constructor (service : H.service.metaInfo.Service | null | H.service.MapTileService , opt_params ? : GlobalObject | null , opt_options ? : H.service.metaInfo.TileProvider.Options ) ;
    protected createTileInternal (x : number , y : number , z : number , data : HTMLImageElement | null | HTMLCanvasElement | GlobalObject , opt_options ? : { [ key: string ]: any } | null ) : H.map.provider.Tile | null ;
    /**
...
declare namespace H.service.metaInfo.TileProvider {
  type Options = { categoryFilter ? : string [] | null , pixelRatio ? : number , scheme ? : string , tileCacheSize ? : number , tileSize ? : number , tileType ? : string } ;
}
declare namespace H.service.omv {
   ...
   *
   * Note that as this provider provides vector data, it can be used only
   * with the `WEBGL` engine {@link H.map.render.webgl.RenderEngine} (see {@link H.Map.Options#engineType}).
   *
   * Use one of the raster layers (e.g. `raster.normal.map`) from {@link H.service.DefaultLayers}
   * when using the `P2D` engine.
   */
  class Provider extends H.map.provider.RemoteTileProvider {
    /**
     * This class represents a provider for continuous fetching of HERE Optimized Map Visualization (OMV) tiles.
     ...
     */
    constructor (service : H.service.omv.Service | null , style : H.map.render.Style < any > | null , opt_options ? : H.map.provider.TileProvider.Options ) ;
    getCache ( ) : H.util.ICache | null ;
    getCopyrights (boundingBox : H.geo.Rect | null , level : number ) : ( H.map.ICopyright | null ) [] | null ;
    /**
     * To obtain the style used for rendering the provider data.
     */
    getStyle ( ) : H.map.render.Style < any > | null ;
    getStyleInternal ( ) : H.map.render.Style < any > | null ;
    getTileKey (x : number , y : number , z : number ) : string ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : ( H.map.Object | null ) [] | null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer , b ? : any ) => any , onError : (a : Error | null ) => any , opt_priority ? : number ) : H.util.ICancelable | null ;
    /**
     * Sets the style to be used for rendering the provider data.
     */
    setStyle (style : H.map.render.Style < any > | null ) : void ;
  }
}
...
declare namespace H.service.omv {
  ...
  class Service extends H.service.Service {
     ...
     * @param opt_options The options to instantiate the provider
     */
    createLayer (style : H.map.render.Style < any > | null , opt_options ? : H.map.provider.TileProvider.Options ) : H.map.layer.TileLayer | null ;
    /**
...
declare namespace H.service.omv.Service {
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , mapVersion ? : string , path ? : string , subDomain ? : string } ;
}
declare namespace H.service.publicTransit {
  ...
  class Service extends H.service.Service {
     ...
     */
    constructor (options : H.service.extension.customRoute.Service.Options ) ;
    /**
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    getDepartures (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * This method sends a request to the [Public Transit API](https://developer.here.com/documentation/public-transit/dev_guide/index.html)
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    getRoutes (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * This method sends a request to the [Public Transit API](https://developer.here.com/documentation/public-transit/dev_guide/index.html)
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    getStations (params : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.publicTransit.Service {
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
declare namespace H.service.traffic {
  /**
   * This class encapsulates the [HERE Traffic API](https://developer.here.com/documentation/traffic/)
   * in a service stub, providing methods to access its resources.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
  ...
  class Service extends H.service.Service {
     ...
     */
    createFlowLayer (opt_additionalParameters ? : GlobalObject | null ) : H.map.layer.TileLayer | null ;
    /**
     * To create a traffic incidents marker tile layer.
     * @param opt_additionalParameters An object containing an additional set of URL parameters
     */
    createIncidentsLayer (opt_additionalParameters ? : GlobalObject | null ) : H.map.layer.MarkerTileLayer | null ;
    /**
     ...
     */
    requestFlowByTile (x : number , y : number , z : number , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_serviceParams ? : GlobalObject | null ) : GlobalObject | null ;
    /**
     * This method requests traffic incidents based on the service parameters provided.
     */
    requestIncidents (serviceParams : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : GlobalObject | null ;
    /**
     ...
     * @param opt_serviceParams optional service parameters to be added to the request
     */
    requestIncidentsByTile (x : number , y : number , z : number , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_serviceParams ? : GlobalObject | null ) : GlobalObject | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.traffic.Service {
  type Options = { baseUrl ? : H.service.Url | null , callbackKey ? : string , path ? : string , subDomain ? : string } ;
}
declare namespace H.service.traffic.flow {
   ...
   *
   * Use `traffic` raster layer from {@link H.service.DefaultLayers} when using the `P2D` engine.
   */
  class Provider extends H.map.provider.RemoteTileProvider {
    /**
     * This class represents a provider for continuous fetching of traffic flow data from the
     ...
     */
    constructor (service : H.service.traffic.Service | null , opt_refreshTime ? : number , opt_additionalParameters ? : GlobalObject | null ) ;
    protected createTileInternal (x : number , y : number , z : number , data : HTMLImageElement | null | HTMLCanvasElement | GlobalObject , opt_options ? : { [ key: string ]: any } | null ) : H.map.provider.Tile | null ;
    /**
     * To obtain the style used for rendering the provider data.
     */
...
declare namespace H.service.xyz {
  /**
   * This class represents a provider for fetching data
   * from [HERE XYZ API](https://developer.here.com/documentation/studio/). The provider
   * could be used only with the `H.Map.EngineType.WEBGL` rendering engine.
   */
  class Provider extends H.map.provider.RemoteTileProvider {
    /**
     * This class represents a provider for fetching data
     * from [HERE XYZ API](https://developer.here.com/documentation/studio/). The provider
     * could be used only with the `H.Map.EngineType.WEBGL` rendering engine.
     * @param service The XYZ service instance.
     * @param spaceId Space ID that defines a given "space" resource.
     * @param opt_options The configuration options for the provider.
     */
    constructor (service : H.service.xyz.Service | null , spaceId : string , opt_options ? : H.service.xyz.Provider.Options ) ;
    getCopyrights (a ? : H.geo.Rect | null , b ? : number ) : ( H.map.ICopyright | null ) [] | null ;
    /**
     * To obtain the style used for rendering the provider data.
     */
    getStyle ( ) : H.map.render.Style < any > | null ;
    ...
    /**
     * Sets the style to be used for rendering the provider data.
     * The style MUST have a space ID as a layer name
     * in order to match data correctly, e.g.:
     */
    setStyle (style : H.map.render.webgl.Style | null ) : void ;
  }
}
declare namespace H.service.xyz.Provider {
  type Options = { limit ? : number , max ? : number , min ? : number , simplificationLevel ? : number , tags ? : string } ;
}
declare namespace H.service.xyz {
  /**
   * This class encapsulates the [HERE XYZ API](https://developer.here.com/documentation/studio/)
   * in a service stub, providing methods to access its resources.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
   * {@link H.service.Platform#getXYZService} on a platform instance.
   */
  class Service extends H.service.Service {
    /**
     * This class encapsulates the [HERE XYZ API](https://developer.here.com/documentation/studio/)
     ...
     * @param options Configuration options for XYZ service.
     */
    constructor (options : H.service.xyz.Service.Options ) ;
    /**
     * To delete multiple features.
     * See [XYZ Hub API Reference - Delete multiple features from the space](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FdeleteFeatures)
     * @param spaceId Space ID that defines a given "space" resource.
     * @param params Service parameters to be added to the request.
     * @param onResult A callback function to be called with an FeatureCollection object containing all the deleted features.
     * @param onError A callback function to be called in case of failed request.
     */
    deleteFeatures (spaceId : string , params : GlobalObject , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To fetch all of the features found in the provided bounding box.
     * See [XYZ Hub API Reference - Get features in bounding box](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FgetFeaturesByBBox).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param params Service parameters to be added to the request.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByBoundingBox (spaceId : string , params : GlobalObject , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : any ;
    /**
     * To fetch all of the features found for the provided list of ids.
     * See [XYZ Hub API Reference - Get features by ID](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FgetFeatures).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param params Service parameters to be added to the request.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesById (spaceId : string , params : GlobalObject , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : any ;
    /**
     * To retrieve a single space data.
     * See [XYZ Hub API Reference - Get a space by ID](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FgetSpace).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object describing the "space" resource.
     * @param onError A callback function to be called in case of failed request.
     */
    getSpace (spaceId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To retrieve spaces that are accessible with current authentication token.
     * By default, only custom spaces are returned,
     * not the common ones (e.g. "Chicago buildings").
     * It is possible to supply the `owner` service parameter to filter spaces by ownership,
     * e.g. `owner: "*"` to retrieve all spaces the user has access to.
     * See [XYZ Hub API Reference - List spaces](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FgetSpaces).
     * @param onResult A callback function to be called with an array of spaces as an argument when request succeeds. Each space is represented as an object with the properties `"id"`, `"title"`, `"description"`, `"owner"` and `"cid"`.
     * @param onError A callback function to be called in case of failed request.
     * @param opt_serviceParams Optional service parameters see [XYZ Hub API Reference – Read Space – Query Parameters](https://developer.here.com/documentation/studio/api-reference-swagger.html#tag%2FRead-Spaces) for more details.
     */
    getSpaces (onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_serviceParams ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To retrieve a statistical information about the space.
     * See [XYZ Hub API Reference - Get statistics](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FgetStatistics).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object containing statistical information about the space.
     * @param onError A callback function to be called in case of failed request.
     */
    getStatistics (spaceId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * To create or patch features.
     * See [XYZ Hub API Reference - Modify features in the space](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FpostFeatures)
     *
     * This method can be used for example for adding new features to the space or adding additional properties to
     * the existing features.
     *
     * Use {@link H.service.xyz.Service#putFeatures} to add/replace features or their properties.
     *
     * See {@link H.map.Object#toGeoJSON} to obtain the GeoJSON representation of a map object.
     * @param spaceId Space ID that defines a given "space" resource.
     * @param geojsonObject A GeoJSON object (`FeatureCollection` or `Feature`) to add/patch in the space.
     * @param onResult A callback function to be called with an FeatureCollection object containing all the modified features.
     * @param onError A callback function to be called in case of failed request.
     * @param opt_params Service parameters to be added to the request.
     */
    postFeatures (spaceId : string , geojsonObject : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To create or replace the provided features.
     * See [XYZ Hub API Reference - Create or replace multiple features](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FputFeatures)
     *
     * This method can be used for example for adding new features to the space or replacing properties of
     * the existing features.
     *
     * Use {@link H.service.xyz.Service#postFeatures} to patch the features or their properties.
     *
     * See {@link H.map.Object#toGeoJSON} to obtain the GeoJSON representation of a map object.
     * @param spaceId Space ID that defines a given "space" resource.
     * @param geojsonObject A GeoJSON object (`FeatureCollection` or `Feature`) to add/replace in the space.
     * @param onResult A callback function to be called with an object containing a FeatureCollection containing all modified features.
     * @param onError A callback function to be called in case of failed request.
     * @param opt_params Service parameters to be added to the request.
     */
    putFeatures (spaceId : string , geojsonObject : GlobalObject | null , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * To search for features in the space.
     * See [XYZ Hub API Reference - Search for features](https://developer.here.com/documentation/studio/api-reference-swagger.html#operation%2FsearchForFeatures).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     * @param opt_params Service parameters to be added to the request.
     */
    search (spaceId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.xyz.Service {
  type Options = { headers ? : GlobalObject | null , token : string } ;
}
declare namespace H.ui {
  ...
  class Control extends H.ui.base.Container {
     ...
     */
    getLocalization ( ) : H.ui.i18n.Localization | null ;
    /**
    ...
    renderInternal (element : GlobalElement | null , doc : Document | null ) : void ;
    /**
     ...
     */
    setAlignment (alignment : H.ui.LayoutAlignment ) : H.ui.Control | null ;
  }
}
declare namespace H.ui {
  /**
...
declare namespace H.ui.DistanceMeasurement {
  type Options = { alignment ? : string , distanceFormatter ? : (a : number ) => string , endIcon ? : H.map.Icon | null , lineStyle ? : null | H.map.SpatialStyle.Options , splitIcon ? : H.map.Icon | null , startIcon ? : H.map.Icon | null , stopoverIcon ? : H.map.Icon | null } ;
}
declare namespace H.ui {
  /**
  ...
  class InfoBubble extends H.ui.base.Element {
     ...
     */
    constructor (position : H.geo.IPoint | null , opt_options ? : H.ui.InfoBubble.Options ) ;
    /**
     ...
     */
    setPosition (position : H.geo.IPoint | null ) : void ;
    /**
...
declare namespace H.ui.InfoBubble {
  type Options = { content ? : string | Node | null , onStateChange ? : (a : H.ui.InfoBubble.State ) => any } ;
  /**
...
declare namespace H.ui.MapSettingsControl {
  type Entry = { label : string , layer ? : H.map.layer.Layer | null } ;
  type Options = { alignment ? : string , baseLayers ? : H.ui.MapSettingsControl.Entry [] | null , layers ? : H.ui.MapSettingsControl.Entry [] | null } ;
}
declare namespace H.ui {
  /**
  ...
  class Overview extends H.ui.Control {
     ...
     */
    constructor (baseLayer : H.map.layer.Layer | null , opt_options ? : H.ui.Overview.Options ) ;
    renderInternal (element : GlobalElement | null , doc : Document | null ) : void ;
    /**
     * This method method sets the base layer of the overview map.
     * @param baseLayer An object representing the base layer
     */
    setBaseLayer (baseLayer : H.map.layer.TileLayer | null ) : H.ui.Overview | null ;
  }
}
...
declare namespace H.ui {
  ...
  class UI extends H.util.EventTarget implements H.util.ICapturable {
     ...
     */
    constructor (map : H.Map | null , opt_options ? : H.ui.UI.Options ) ;
    /**
     * This method adds an info bubble to the UI.
     * @param bubble The info bubble to be added
     */
    addBubble (bubble : H.ui.InfoBubble | null ) : void ;
    /**
     ...
     */
    getControl (name : string ) : H.ui.Control | null ;
    /**
     ...
     */
    removeBubble (bubble : H.ui.InfoBubble | null ) : void ;
    /**
     ...
     */
    removeControl (name : string ) : H.ui.Control | null ;
    /**
     ...
     */
    static createDefault (map : H.Map | null , defaultLayers : H.service.DefaultLayers , opt_locale ? : H.ui.i18n.Localization | null | string ) : H.ui.UI | null ;
  }
}
declare namespace H.ui.UI {
  type Options = { distancemeasurement ? : H.ui.DistanceMeasurement.Options | boolean , locale ? : H.ui.i18n.Localization | null | string , mapsettings ? : H.ui.MapSettingsControl.Options | boolean , scalebar ? : H.ui.ScaleBar.Options | boolean , unitSystem ? : H.ui.UnitSystem , zoom ? : H.ui.ZoomControl.Options | boolean , zoomrectangle ? : H.ui.ScaleBar.Options | boolean } ;
}
declare namespace H.ui {
  /**
...
declare namespace H.ui {
  ...
  class ZoomControl extends H.ui.Control {
    ...
    renderInternal (element : GlobalElement | null , doc : Document | null ) : void ;
    setAlignment (alignment : H.ui.LayoutAlignment ) : H.ui.Control | null ;
    setDisabled (opt_disabled ? : boolean , opt_force ? : boolean ) : H.ui.base.Element | null ;
    /**
...
declare namespace H.ui.base {
  ...
  class Button extends H.ui.base.Element {
     ...
     */
    setLabel (label : string , opt_force ? : boolean ) : H.ui.base.Button | null ;
    /**
     ...
     */
    setState (state : H.ui.base.Button.State , opt_suppressEvent ? : boolean ) : H.ui.base.Button | null ;
  }
}
declare namespace H.ui.base.Button {
  type Options = { data : any , disabled ? : boolean , label ? : string , onStateChange ? : (a : H.util.Event | null ) => any } ;
  /**
...
declare namespace H.ui.base {
  ...
  class Container extends H.ui.base.Element {
     ...
     */
    constructor (opt_elementType ? : string , opt_className ? : string , opt_children ? : ( H.ui.base.Element | null ) [] | null ) ;
    /**
     ...
     */
    addChild (child : H.ui.base.Element | null ) : H.ui.base.Container | null ;
    /**
     * This method retrieves the child element collection of the given container.
     */
    getChildren ( ) : ( H.ui.base.Element | null ) [] | null ;
    /**
     ...
     */
    removeChild (child : H.ui.base.Element | null ) : void ;
    renderInternal (element : GlobalElement | null , doc : Document | null ) : void ;
    setDisabled (opt_disabled ? : boolean , opt_force ? : boolean ) : H.ui.base.Element | null ;
  }
}
declare namespace H.ui.base {
  ...
  class Element extends H.util.EventTarget {
     ...
     */
    addClass (className : string ) : H.ui.base.Element | null ;
    /**
     ...
     */
    removeClass (className : string ) : H.ui.base.Element | null ;
    /**
...
declare namespace H.ui.base {
  ...
  class OverlayPanel extends H.ui.base.Container {
     ...
     */
    pointToControl (control : H.ui.Control | null ) : void ;
    /**
     ...
     */
    setState (state : H.ui.base.OverlayPanel.State , opt_force ? : boolean ) : H.ui.base.OverlayPanel | null ;
  }
}
...
declare namespace H.ui.base {
  ...
  class PushButton extends H.ui.base.Button {
     ...
     */
    toggleState ( ) : H.ui.base.PushButton | null ;
  }
}
declare namespace H.ui.base {
  /**
  ...
  class RadioGroup extends H.ui.base.Container {
     ...
     */
    addButton (button : H.ui.base.PushButton | null ) : H.ui.base.RadioGroup | null ;
    /**
     * This method retrieves the buttons currently registered with the given group.
     */
    getButtons ( ) : ( H.ui.base.PushButton | null ) [] | null ;
    /**
     ...
     */
    removeButton (button : H.ui.base.PushButton | null ) : H.ui.base.RadioGroup | null ;
    renderInternal (element : GlobalElement | null , doc : Document | null ) : void ;
    /**
     ...
     */
    setActiveButton (button : H.ui.base.PushButton | null , opt_suppressEvent ? : boolean ) : void ;
    /**
     ...
     */
    setTitle (title : string , opt_force ? : boolean ) : H.ui.base.RadioGroup | null ;
  }
}
declare namespace H.ui.base.RadioGroup {
  type Options = { buttonsOptions ? : H.ui.base.Button.Options [] | null , title ? : string } ;
}
declare namespace H.ui.i18n {
   ...
   */
  let defaultLocales : string [] | null ;
}
declare namespace H.ui.i18n {
  /**
  ...
  class Localization {
     ...
     */
    constructor (locale : string , opt_translationMap ? : GlobalObject | null ) ;
    /**
...
declare namespace H.util {
  ...
  class AsyncQueue {
     ...
     */
    constructor (mode : H.util.AsyncQueue.Mode | null , processFn : (a : H.util.AsyncQueue.Task | null , b : any ) => any ) ;
    /**
     ...
     */
    push (data : any , onDone : (a : H.util.AsyncQueue.Task | null , b : any , c : any ) => any ) : H.util.AsyncQueue.Task | null ;
  }
}
declare namespace H.util.AsyncQueue {
  ...
  class Task implements H.util.ICancelable {
     ...
     */
    setCancelFn (cancelFn : ( ) => any ) : H.util.AsyncQueue.Task | null ;
  }
}
declare namespace H.util {
  /**
  ...
  class Cache implements H.util.ICache {
    ...
    drop (id : any ) : void ;
    forEach (callback : (a : string , b : any , c : number ) => any , opt_ctx ? : GlobalObject | null , opt_matcher ? : (a : string , b : any , c : number ) => boolean ) : void ;
    /**
     ...
     */
    setMaxSize (maxSize : number ) : H.util.Cache | null ;
  }
}
declare namespace H.util {
  /**
...
declare namespace H.util {
  ...
  class ContextItem extends H.util.EventTarget {
     ...
     */
    setDisabled (disabled : boolean ) : H.util.ContextItem | null ;
    /**
     * This method sets the context item label.
     * @param label A new label for the context item
     */
    setLabel (label : string ) : H.util.ContextItem | null ;
    /**
     * This constant represents the separator for the context item.
     */
    static SEPARATOR : H.util.ContextItem | null ;
  }
}
declare namespace H.util.ContextItem {
  type Options = { callback ? : (a : H.util.Event | null ) => any , disabled ? : boolean , label ? : string } ;
}
declare namespace H.util {
  /**
  ...
  class DataEvent < T = any > extends H.util.Event {
     ...
     */
    constructor (type : string , data : T , opt_target ? : GlobalObject | null ) ;
    /**
...
declare namespace H.util {
  ...
  class Disposable extends goog.Disposable {
     ...
     */
    addOnDisposeCallback (a : Function , b ? : GlobalObject | null ) : any ;
  }
}
declare namespace H.util {
  /**
  ...
  class ErrorEvent extends H.util.Event {
     ...
     * @param opt_target A reference to the object that is the target of the given event. It must implement the `EventTarget` interface.
     */
    constructor (type : string , message : string , opt_target ? : GlobalObject | null ) ;
    /**
     * Error message.
     */
    message : string ;
...
declare namespace H.util {
  ...
  class Event extends goog.events.Event {
     ...
     * @param opt_target A reference to the object that is the target of the given event. It must implement the `EventTarget` interface.
     */
    constructor (a : string , b ? : GlobalObject | null ) ;
    /**
...
declare namespace H.util {
  ...
  class EventTarget extends goog.events.EventTarget {
     ...
     */
    addEventListener (a : string , b : Function , c ? : boolean , d ? : GlobalObject | null ) : any ;
    /**
     ...
     */
    dispatchEvent (a : H.util.Event | null | string ) : any ;
    /**
     ...
     * @param opt_scope An object defining the scope for the handler function
     */
    removeEventListener (a : string , b : Function , c ? : boolean , d ? : GlobalObject | null ) : any ;
  }
}
declare namespace H.util {
  /**
...
declare namespace H.util.OList {
  ...
  class Event extends H.util.Event {
     ...
     */
    constructor (list : H.util.OList | null , type : string , idx : number , added : any , removed : any , moved : any ) ;
  }
}
declare namespace H.util {
  /**
  ...
  abstract class Request {
     ...
     */
    constructor (opt_onprogress ? : (a : H.util.Request | null ) => any , opt_total ? : number ) ;
    /**
...
declare namespace H.util.flexiblePolyline {
   ...
   */
  type Data = { polyline : ( number [] | null ) [] | null , precision ? : number , thirdDim ? : number , thirdDimPrecision ? : number } ;
  /**
...
declare namespace H.util.wkt {
   ...
   */
  function toGeometry (wkt : string ) : H.geo.AbstractGeometry | null ;
}
