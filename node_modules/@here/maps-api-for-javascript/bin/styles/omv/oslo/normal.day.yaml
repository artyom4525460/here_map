...
global:
  ...
  # TODO: to port from Oslo - There is no style mountain peaks in Oslo just yet
    ...
    borough:
      ...
      label:
        font:
          ...
          stroke:
            color: place_class5_outline_color
            width: global.place_class5_font_stroke_width
  ...
  place_village_font_size: place_class5_font_size
  ...
  #######################################################  POIS  #######################################################
  # TODO: to port from Oslo (provided that style for pois is finalized)
  poi:
    icon:
      size: 10px
    label:
