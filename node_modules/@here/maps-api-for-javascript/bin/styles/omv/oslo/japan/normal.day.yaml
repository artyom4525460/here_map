    ...
    shaders:
      ...
      blocks:
        color: |
          ...
          vec2 st = (getTileCoords()*(DOTS_SCALE / dots_spacing)) * 2.;
...
fonts:
  DroidSansFallback:
    - weight: normal
      url: ../../../fonts/DroidSansFallback/DroidSansFallback.woff
...
global:
  ...
  # Uses Hiragino Sans MacOS system font & DroidSansFallback for CJK glyphs
  text_font_family: 'FiraGO, Hiragino Sans, DroidSansFallback'
  ux_language: ja
  ...
  road:
    ...
    # TODO: move "major.tertiary" under IPC section during MAPSJS-2799:
    major:
      tertiary:
        link:
          line:
  ...
  polygonal_roads:
    ...
    tunnel:
      ...
      z21:
        ...
        draw:
          lines:
            dash: global.landuse.IPC.tunnel.z21.dash
      z22:
        filter:
          $zoom: {min: 22}
        draw:
          lines:
            dash: global.landuse.IPC.tunnel.z22.dash
  ...
  roads:
    rail:
      ...
      IPC:
        ...
        draw:
          text-blend-order:
            priority: global.priority_offset.road_labels
      ...
      IPC:
        ...
        draw:
          jp_shields:
            priority: |
              function() {
                return global.priority_offset.road_shields + 6
              }
            visible: global.shields_visible
          shields:
            visible: false
        default_priority_motorway:
          ...
          draw:
            jp_shields:
              priority: |
                function() {
                  return global.priority_offset.road_shields + 1
                }
            shields:
              visible: false
        default_priority_trunk:
          ...
          draw:
            jp_shields:
              priority: |
                function() {
                  return global.priority_offset.road_shields + 2
                }
            shields:
              visible: false
        default_priority_primary:
          ...
          draw:
            jp_shields:
              priority: |
                function() {
                  return global.priority_offset.road_shields + 3
                }
            shields:
              visible: false
        default_priority_secondary:
          ...
          draw:
            jp_shields:
              priority: |
                function() {
                  return global.priority_offset.road_shields + 4
                }
            shields:
              visible: false
        default_priority_tertiary:
          ...
          draw:
            jp_shields:
              priority: |
                function() {
                  return global.priority_offset.road_shields + 5
                }
            shields:
              visible: false
        default_minor_road:
      ...
      microhood:
        ...
        draw:
          text-blend-order:
            ...
            priority: |
              function() {
                return global.priority_offset.places + 2
              }
            font:
        ...
        parcel:
          ...
          draw:
            text-blend-order:
              ...
              priority: |
                function() {
                  return global.priority_offset.places + 3
                }
      oaza:
        filter:
          kind: oaza
        ...
        draw:
          text-blend-order:
            visible: true
            text_source: global.ux_language_text_source
            priority: global.priority_offset.places
            font:
              fill: global.places.IPC.label.oaza.font.fill
      ...
      aza:
        ...
        draw:
          text-blend-order:
            ...
            priority: |
              function() {
                return global.priority_offset.places + 1
              }
            font:
